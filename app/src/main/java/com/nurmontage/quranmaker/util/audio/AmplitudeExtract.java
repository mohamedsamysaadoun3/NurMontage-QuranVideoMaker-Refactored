...
import com.nurmontage.quranmaker.util.audio.AmplitudeExtract;
...
public class AmplitudeExtract {
    ...
    public void extractAmplitudeDataAsync(final String str, final int i, final AmplitudeDataCallback amplitudeDataCallback) {
        this.executorService.execute(new Runnable() { // from class: com.nurmontage.quranmaker.util.audio.AmplitudeExtract$$ExternalSyntheticLambda0
    ...
    /* renamed from: lambda$extractAmplitudeDataAsync$2$com-nurmontage-quranmaker-util-audio-AmplitudeExtract, reason: not valid java name */
    /* synthetic */ void m897x997f050d(String str, int i, final AmplitudeDataCallback amplitudeDataCallback) {
        try {
            ...
            this.mainHandler.post(new Runnable() { // from class: com.nurmontage.quranmaker.util.audio.AmplitudeExtract$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
            ...
            this.mainHandler.post(new Runnable() { // from class: com.nurmontage.quranmaker.util.audio.AmplitudeExtract$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
