...
public class SmoothTimelineAnimator {
    ...
    private final Choreographer.FrameCallback frameCallback = new Choreographer.FrameCallback() { // from class: com.nurmontage.quranmaker.util.render.SmoothTimelineAnimator.1
