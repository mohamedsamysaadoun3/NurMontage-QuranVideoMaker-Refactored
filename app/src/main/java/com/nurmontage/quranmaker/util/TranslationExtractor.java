...
public class TranslationExtractor {
    public static void convertJsonToTxt(Context context, String str, String str2) {
        try {
            ...
            Collections.sort(arrayList, new Comparator() { // from class: com.nurmontage.quranmaker.util.TranslationExtractor$$ExternalSyntheticLambda1
            ...
            for (String str3 : arrayList) {
                ...
                if (!string.matches("\\(\\d+\\)") && !string.matches("\\d+")) {
                    ((Map) linkedHashMap.computeIfAbsent(str6, new Function() { // from class: com.nurmontage.quranmaker.util.TranslationExtractor$$ExternalSyntheticLambda2
    ...
    */
    public static void extractTranslationsBySurahAndAyah(android.content.Context r16) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nurmontage.quranmaker.util.TranslationExtractor.extractTranslationsBySurahAndAyah(android.content.Context):void");
    }
}
