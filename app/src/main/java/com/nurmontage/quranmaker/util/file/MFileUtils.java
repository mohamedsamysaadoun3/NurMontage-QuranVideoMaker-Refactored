package com.nurmontage.quranmaker.util.file;
...
public class MFileUtils {
    ...
    */
    public static com.nurmontage.quranmaker.util.file.MFileUtils.FileInfo getFileInfo(android.content.Context r13, java.lang.String r14) {
        /*
        ...
        Lb9:
            com.nurmontage.quranmaker.util.file.MFileUtils$FileInfo r13 = new com.nurmontage.quranmaker.util.file.MFileUtils$FileInfo
            r13.<init>(r2, r0)
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nurmontage.quranmaker.util.file.MFileUtils.getFileInfo(android.content.Context, java.lang.String):com.nurmontage.quranmaker.util.file.MFileUtils$FileInfo");
    }
