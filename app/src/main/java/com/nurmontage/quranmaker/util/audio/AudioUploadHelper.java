...
public class AudioUploadHelper {
    ...
    */
    public static java.io.File processAudioUriForUpload(android.content.Context r7, android.net.Uri r8, java.lang.String r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nurmontage.quranmaker.util.audio.AudioUploadHelper.processAudioUriForUpload(android.content.Context, android.net.Uri, java.lang.String):java.io.File");
    }
}
