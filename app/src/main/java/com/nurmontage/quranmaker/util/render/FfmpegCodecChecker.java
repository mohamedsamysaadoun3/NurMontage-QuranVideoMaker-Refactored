package com.nurmontage.quranmaker.util.render;
...
public class FfmpegCodecChecker {
    ...
    public static void detectCodecsAsync(final CodecCallback codecCallback) {
        ...
        if (codecInfo != null) {
            ...
            FFmpegKit.executeAsync("-hide_banner -encoders", new FFmpegSessionCompleteCallback() { // from class: com.nurmontage.quranmaker.util.render.FfmpegCodecChecker$$ExternalSyntheticLambda0
