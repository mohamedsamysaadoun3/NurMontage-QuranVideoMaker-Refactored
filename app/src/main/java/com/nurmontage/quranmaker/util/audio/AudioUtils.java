package com.nurmontage.quranmaker.util.audio;
...
public class AudioUtils {
    ...
    public static void copyToLocalAsync(final Context context, final String str, final String str2, final Callback callback) {
        executor.execute(new Runnable() { // from class: com.nurmontage.quranmaker.util.audio.AudioUtils$$ExternalSyntheticLambda2
    ...
    static /* synthetic */ void lambda$copyToLocalAsync$2(String str, Context context, String str2, final Callback callback) {
        ...
        try {
            ...
            mainHandler.post(new Runnable() { // from class: com.nurmontage.quranmaker.util.audio.AudioUtils$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
            ...
            mainHandler.post(new Runnable() { // from class: com.nurmontage.quranmaker.util.audio.AudioUtils$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    */
    public static java.lang.String downloadFile(android.content.Context r7, java.lang.String r8, java.lang.String r9) {
        ...
        Laa:
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nurmontage.quranmaker.util.audio.AudioUtils.downloadFile(android.content.Context, java.lang.String, java.lang.String):java.lang.String");
    }
