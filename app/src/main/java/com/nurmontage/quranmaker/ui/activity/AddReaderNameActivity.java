...
public class AddReaderNameActivity extends Base {
    ...
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.AddReaderNameActivity.1
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.AddReaderNameActivity$$ExternalSyntheticLambda0
        ...
        hideSystemBars();
        findViewById(R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AddReaderNameActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AddReaderNameActivity.this.onBackPressedCallback.handleOnBackPressed();
            }
        });
        findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AddReaderNameActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AddReaderNameActivity.this.closeKeyboard();
                Intent intent = new Intent();
