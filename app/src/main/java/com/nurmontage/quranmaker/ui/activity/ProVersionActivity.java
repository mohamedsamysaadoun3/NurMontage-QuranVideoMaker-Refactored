...
import com.nurmontage.quranmaker.ui.activity.ProVersionActivity;
...
import com.nurmontage.quranmaker.ui.adapter.ImgAdapter;
...
public class ProVersionActivity extends Base implements PurchasesUpdatedListener {
    ...
    private ButtonCustomFontBilling btnContinue;
    ...
    private TextCustomFont tvByMonth;
    private TextCustomFont tvNoCommitmentAr;
    private TextCustomFont tvNoCommitmentEn;
    private TextView tv_best;
    private TextCustomFontBold tv_price_foreiver;
    private TextCustomFontBold tv_price_year;
    private YouTubePlayer youTubePlayer;
    private YouTubePlayerView youTubePlayerView;
    private final int color_select = -1;
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.1
    ...
    private final Runnable autoScrollRunnable = new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.15
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$$ExternalSyntheticLambda3
        ...
        findViewById(R.id.btn_on_back).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.2
        ...
        this.btn_restore.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
        ...
        this.tv_price_year = (TextCustomFontBold) findViewById(R.id.tv_price_year);
        this.tv_price_foreiver = (TextCustomFontBold) findViewById(R.id.tv_price_month);
        this.tvByMonth = (TextCustomFont) findViewById(R.id.tv_year_bymonth);
        ...
        this.btn_foreiver.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.btn_year.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        ButtonCustomFontBilling buttonCustomFontBilling = (ButtonCustomFontBilling) findViewById(R.id.btn_continue);
        this.btnContinue = buttonCustomFontBilling;
        buttonCustomFontBilling.setText(this.mResources.getString(R.string.subscribe_now));
        this.btnContinue.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
        ...
        this.tvNoCommitmentAr = (TextCustomFont) findViewById(R.id.tv_hint_ar);
        this.tvNoCommitmentEn = (TextCustomFont) findViewById(R.id.tv_hint_en);
    ...
    private void showFeatures() {
        try {
            ...
            inflate.findViewById(R.id.dialog_no).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.7
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
    ...
    public void initBtnHelp(boolean z) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public void startBillingConnection() {
        this.billingClient.startConnection(new BillingClientStateListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.9
    ...
    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$10, reason: invalid class name */
    class AnonymousClass10 implements ProductDetailsResponseListener {
        ...
        public void onProductDetailsResponse(BillingResult billingResult, List<ProductDetails> list) {
            ...
            for (final ProductDetails productDetails : list) {
                ...
                ProVersionActivity.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$10$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
        ...
        /* renamed from: lambda$onProductDetailsResponse$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivity$10, reason: not valid java name */
    ...
    private void queryUserPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$$ExternalSyntheticLambda2
    ...
    /* renamed from: lambda$queryUserPurchases$1$com-nurmontage-quranmaker-ui-activity-ProVersionActivity, reason: not valid java name */
    ...
    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$11, reason: invalid class name */
    class AnonymousClass11 implements ProductDetailsResponseListener {
        ...
        public void onProductDetailsResponse(BillingResult billingResult, List<ProductDetails> list) {
            ...
            for (final ProductDetails productDetails : list) {
                ProVersionActivity.this.productDetailsMap.put(productDetails.getProductId(), productDetails);
                ProVersionActivity.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$11$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        /* renamed from: lambda$onProductDetailsResponse$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivity$11, reason: not valid java name */
    ...
    public void queryPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$$ExternalSyntheticLambda4
            @Override // com.android.billingclient.api.PurchasesResponseListener
            public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
    ...
    /* renamed from: lambda$queryPurchases$2$com-nurmontage-quranmaker-ui-activity-ProVersionActivity, reason: not valid java name */
    ...
    private void handlePurchase(Purchase purchase) {
        if (purchase.getPurchaseState() == 1) {
            ...
            this.billingClient.acknowledgePurchase(AcknowledgePurchaseParams.newBuilder().setPurchaseToken(purchase.getPurchaseToken()).build(), new AcknowledgePurchaseResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$$ExternalSyntheticLambda6
        ...
        if (purchase.getPurchaseState() == 2) {
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.12
                @Override // java.lang.Runnable
                public void run() {
            ...
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.13
                @Override // java.lang.Runnable
                public void run() {
    ...
    private void thnks() {
        try {
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.14
                @Override // java.lang.Runnable
                public void run() {
                    ...
                    TextCustomFont textCustomFont = (TextCustomFont) ProVersionActivity.this.findViewById(R.id.tv_thanks);
                    textCustomFont.setVisibility(0);
                    textCustomFont.setText(ProVersionActivity.this.mResources.getString(R.string.thanks_hint));
    ...
    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$16, reason: invalid class name */
    class AnonymousClass16 implements Runnable {
        ...
        public void run() {
            ...
            ProVersionActivity.this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.16.1
            ...
            ProVersionActivity.this.recyclerView.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$16$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ProVersionActivity.AnonymousClass16.this.m716lambda$run$0$com.nurmontage.quranmaker.ui.activityProVersionActivity$16(arrayList);
                }
            });
            ProVersionActivity.this.startAutoScroll();
        }

        /* renamed from: lambda$run$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivity$16, reason: not valid java name */
        /* synthetic */ void m716lambda$run$0$com.nurmontage.quranmaker.ui.activityProVersionActivity$16(List list) {
    ...
    public void checkUserSubscriptionStatus() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("subs").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.17
            @Override // com.android.billingclient.api.PurchasesResponseListener
    ...
    public void checkInAppPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity$$ExternalSyntheticLambda5
            @Override // com.android.billingclient.api.PurchasesResponseListener
            public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
    ...
    /* renamed from: lambda$checkInAppPurchases$4$com-nurmontage-quranmaker-ui-activity-ProVersionActivity, reason: not valid java name */
    /* synthetic */ void m711x2348ddd(BillingResult billingResult, List list) {
        ...
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.18
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void handleNoPurchases() {
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.19
            @Override // java.lang.Runnable
            public void run() {
                ProVersionActivity.this.hideProgressFragment();
    ...
    private void playVibration() {
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivity.20
            @Override // java.lang.Runnable
            public void run() {
