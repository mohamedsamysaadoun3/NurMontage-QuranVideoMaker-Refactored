...
public class EyeOpenView extends View {
    ...
    public void startEyeOpenAnimation(long j) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.nurmontage.quranmaker.ui.view.EyeOpenView$$ExternalSyntheticLambda0
    ...
    /* renamed from: lambda$startEyeOpenAnimation$0$com-nurmontage-quranmaker-ui-view-EyeOpenView, reason: not valid java name */
