...
import com.nurmontage.quranmaker.databinding.FragmentEditTextBinding;
...
import com.nurmontage.quranmaker.ui.view.ArrowOverlayDecoration;
...
public class EditTextFragment extends Fragment {
    ...
    private WordAyaAdapter.IWordAya iWordAya = new WordAyaAdapter.IWordAya() { // from class: com.nurmontage.quranmaker.ui.fragment.EditTextFragment.2
        @Override // com.nurmontage.quranmaker.ui.adapter.WordAyaAdapter.IWordAya
        public void onClick() {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.quranEntity != null && this.iEditEntityCallback != null) {
            init(root);
            root.findViewById(R.id.btn_close).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditTextFragment.1
    ...
    private void init(View view) {
        ...
        this.wordAyaAdapter = new WordAyaAdapter(this.iWordAya, arrayList);
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.rv);
        this.recyclerView = recyclerView;
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext(), 0, true));
        this.recyclerView.setHasFixedSize(true);
        this.recyclerView.setItemAnimator(null);
        this.recyclerView.setAdapter(this.wordAyaAdapter);
        try {
    ...
    public void update(QuranEntity quranEntity) {
        ...
        this.wordAyaAdapter.setList(arrayList);
        try {
            this.recyclerView.scrollToPosition(startWord_index);
        } catch (Exception e) {
            e.printStackTrace();
