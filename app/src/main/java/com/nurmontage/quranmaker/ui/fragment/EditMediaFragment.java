...
import com.nurmontage.quranmaker.databinding.FragmentEditMediaBinding;
...
public class EditMediaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditMediaCallback != null && this.resources != null && this.entity_select != null) {
            ...
            final int scrollX = MyPreferences.getScrollX(getContext());
            if (scrollX != 0) {
                MyPreferences.putScrollX(getContext(), 0);
                horizontalScrollView.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.1
            ...
            horizontalScrollView.setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.2
            ...
            ((TextCustomFont) root.findViewById(R.id.tv_enhance)).setText(this.resources.getString(R.string.enhance));
            ...
            ((TextCustomFont) root.findViewById(R.id.tv_volume)).setText(this.resources.getString(R.string.volume));
            ((TextCustomFont) root.findViewById(R.id.tv_reverbe)).setText(this.resources.getString(R.string.reverb));
            ((TextCustomFont) root.findViewById(R.id.tv_echo)).setText(this.resources.getString(R.string.echo));
            ((TextCustomFont) root.findViewById(R.id.tv_fade)).setText(this.resources.getString(R.string.fade));
            ((TextCustomFont) root.findViewById(R.id.tv_noice)).setText(this.resources.getString(R.string.noice));
            ((TextCustomFont) root.findViewById(R.id.tv_speed)).setText(this.resources.getString(R.string.speed));
            ...
            root.findViewById(R.id.btn_delete).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.3
            ...
            root.findViewById(R.id.btn_duplicate).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.4
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.5
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
                        MyPreferences.putScrollX(EditMediaFragment.this.getContext(), horizontalScrollView.getScrollX());
            ...
            linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.6
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
                        MyPreferences.putScrollX(EditMediaFragment.this.getContext(), horizontalScrollView.getScrollX());
            ...
            linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.7
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
                        MyPreferences.putScrollX(EditMediaFragment.this.getContext(), horizontalScrollView.getScrollX());
            ...
            linearLayout4.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.8
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
                        MyPreferences.putScrollX(EditMediaFragment.this.getContext(), horizontalScrollView.getScrollX());
            ...
            linearLayout5.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.9
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
                        MyPreferences.putScrollX(EditMediaFragment.this.getContext(), horizontalScrollView.getScrollX());
            ...
            linearLayout6.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.10
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
                        MyPreferences.putScrollX(EditMediaFragment.this.getContext(), horizontalScrollView.getScrollX());
            ...
            linearLayout7.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.11
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
                        MyPreferences.putScrollX(EditMediaFragment.this.getContext(), horizontalScrollView.getScrollX());
            ...
            this.btn_cut.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditMediaFragment.12
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditMediaFragment.this.iEditMediaCallback != null) {
    ...
    public void updateBtn() {
        try {
            ...
            if (this.entity_select.getEffectAudio().isRemoveNoise()) {
