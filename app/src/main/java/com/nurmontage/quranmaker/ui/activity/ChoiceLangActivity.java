...
public class ChoiceLangActivity extends Base {
    ...
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.ChoiceLangActivity.1
    ...
    private void initViews() {
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ChoiceLangActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChoiceLangActivity.this.m468x20d8e885(imageView, imageView2, relativeLayout, relativeLayout2, view);
            }
        });
        relativeLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ChoiceLangActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChoiceLangActivity.this.m469x5aa38a64(imageView, imageView2, relativeLayout2, relativeLayout, view);
            }
        });
        button.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ChoiceLangActivity$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChoiceLangActivity.this.m470x946e2c43(view);
            }
        });
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ChoiceLangActivity$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* renamed from: lambda$initViews$0$com-nurmontage-quranmaker-ui-activity-ChoiceLangActivity, reason: not valid java name */
    ...
    /* renamed from: lambda$initViews$1$com-nurmontage-quranmaker-ui-activity-ChoiceLangActivity, reason: not valid java name */
    ...
    /* renamed from: lambda$initViews$2$com-nurmontage-quranmaker-ui-activity-ChoiceLangActivity, reason: not valid java name */
    /* synthetic */ void m470x946e2c43(View view) {
        this.lang = this.isEnglishSelected ? "en" : "ar";
        start();
    }

    /* renamed from: lambda$initViews$3$com-nurmontage-quranmaker-ui-activity-ChoiceLangActivity, reason: not valid java name */
