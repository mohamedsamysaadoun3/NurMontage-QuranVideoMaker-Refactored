...
import com.nurmontage.quranmaker.util.AppSettingsHelper;
import com.nurmontage.quranmaker.util.AppUtils;
import com.nurmontage.quranmaker.util.ScreenUtils;
import com.nurmontage.quranmaker.ui.adapter.ExploreAdapters;
import com.nurmontage.quranmaker.ui.adapter.GalleryPickerAdapters;
...
public class GalleryPickerOneImage extends Base {
    ...
    private TextCustomFont btnExplore;
    private GalleryPickerAdapters galleryPickerAdapters;
    private boolean isUpdate;
    private LinearLayout layoutSetting;
    private PhotoItem mPhotoItem;
    private Resources mResources;
    private RecyclerView rv_explore;
    private OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.1
    ...
    private GalleryPickerVideo.IPicker iPicker = new GalleryPickerVideo.IPicker() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.2
        @Override // com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.IPicker
    ...
    private ExploreAdapters.IExplore iExplore = new ExploreAdapters.IExplore() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.3
        @Override // com.nurmontage.quranmaker.ui.adapter.ExploreAdapters.IExplore
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage$$ExternalSyntheticLambda0
        ...
        this.btnDone.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.4
    ...
    public void setSetting(boolean z) {
        ...
        this.layoutSetting.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private void initFolder() {
        TextCustomFont textCustomFont = (TextCustomFont) findViewById(R.id.tv_folders);
        this.btnExplore = textCustomFont;
        textCustomFont.setText(this.mResources.getString(R.string.all));
        this.btnExplore.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        new Thread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.7
            ...
            public void run() {
                ...
                GalleryPickerOneImage.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.7.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ...
                        GalleryPickerOneImage.this.galleryPickerAdapters = new GalleryPickerAdapters(AppUtils.getAppVersionName(GalleryPickerOneImage.this), GalleryPickerOneImage.this.mResources, null, (int) (ScreenUtils.getScreenWidth(GalleryPickerOneImage.this) * 0.3f), GalleryPickerOneImage.this.iPicker);
                        GalleryPickerOneImage.this.galleryPickerAdapters.addItems(arrayList2);
                        recyclerView.setAdapter(GalleryPickerOneImage.this.galleryPickerAdapters);
                    }
                });
                String str6 = str3;
                ...
                GalleryPickerOneImage.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.7.2
                    @Override // java.lang.Runnable
                    public void run() {
                        GalleryPickerOneImage.this.galleryPickerAdapters.doneItems(arrayList2);
                        GalleryPickerOneImage.this.galleryPickerAdapters.notifyDataSetChanged();
                        ...
                        GalleryPickerOneImage.this.rv_explore.setAdapter(new ExploreAdapters(arrayList, (int) (ScreenUtils.getScreenWidth(GalleryPickerOneImage.this) * 0.2f), GalleryPickerOneImage.this.iExplore, GalleryPickerOneImage.this.btnExplore.getText().toString()));
    ...
    private void initViews() {
        findViewById(R.id.btn_onBack).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerOneImage.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                GalleryPickerOneImage.this.finish();
            }
    ...
    public void changeFolder(String str) {
        if (str.equals(this.mResources.getString(R.string.all))) {
            this.galleryPickerAdapters.updateAll();
        } else {
            this.galleryPickerAdapters.update(str);
        }
    }
}
