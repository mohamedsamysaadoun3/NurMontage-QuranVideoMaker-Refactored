...
import com.nurmontage.quranmaker.databinding.FragmentEditSNameBinding;
...
public class EditS_NameFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditSName != null && this.resources != null && this.entity_select != null) {
            ...
            root.findViewById(R.id.btn_font).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditS_NameFragment.1
            ...
            root.findViewById(R.id.btn_color).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditS_NameFragment.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditS_NameFragment.this.iEditSName != null) {
            ...
            root.findViewById(R.id.btn_edit).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditS_NameFragment.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditS_NameFragment.this.iEditSName != null) {
