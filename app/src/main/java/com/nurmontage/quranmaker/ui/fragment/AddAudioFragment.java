...
import com.nurmontage.quranmaker.databinding.FragmentAddAudioBinding;
...
public class AddAudioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.resources != null && this.iAudioCallback != null) {
            ((TextCustomFont) root.findViewById(R.id.tv_extract)).setText(this.resources.getString(R.string.extract_audio));
            ((TextCustomFont) root.findViewById(R.id.tv_audio)).setText(this.resources.getString(R.string.audio));
            root.findViewById(R.id.btn_upload).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.AddAudioFragment.1
            ...
            root.findViewById(R.id.btn_extract).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.AddAudioFragment.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (AddAudioFragment.this.iAudioCallback != null) {
            ...
            root.findViewById(R.id.btn_close).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.AddAudioFragment.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (AddAudioFragment.this.iAudioCallback != null) {
