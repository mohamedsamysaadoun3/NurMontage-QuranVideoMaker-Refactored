...
import com.nurmontage.quranmaker.util.file.MFileUtils;
import com.nurmontage.quranmaker.util.ScreenUtils;
import com.nurmontage.quranmaker.ui.adapter.WorkUserAdapter;
...
public class WorkUserActivity extends Base {
    ...
    private OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.1
        ...
        public void handleOnBackPressed() {
            try {
                if (WorkUserActivity.this.backPressedOnce) {
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.1.1
    ...
    private WorkUserAdapter.IWorkUserCallback iWorkUserCallback = new WorkUserAdapter.IWorkUserCallback() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.10
        @Override // com.nurmontage.quranmaker.ui.adapter.WorkUserAdapter.IWorkUserCallback
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity$$ExternalSyntheticLambda0
        ...
        initRv();
        findViewById(R.id.btn_menu).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                WorkUserActivity.this.startActivity(new Intent(WorkUserActivity.this, (Class<?>) SettingsActivity.class));
                WorkUserActivity.this.finish();
            }
        });
        ...
        findViewById(R.id.tv_secret).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public void showPopup(View view, final Template template, final int i) {
        ...
        ((RelativeLayout) inflate.findViewById(R.id.btn_share)).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.4
            @Override // android.view.View.OnClickListener
        ...
        ((RelativeLayout) inflate.findViewById(R.id.btn_delete)).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                try {
                    WorkUserActivity workUserActivity = WorkUserActivity.this;
        ...
        ((RelativeLayout) inflate.findViewById(R.id.btn_duplicate)).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                try {
                    ...
                    WorkUserActivity.this.workUserAdapter.add(i + 1, duplicate);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                if (WorkUserActivity.this.popupWindow != null) {
        ...
        ((TextCustomFont) inflate.findViewById(R.id.tv_share)).setText(this.mResources.getString(R.string.just_share));
        ((TextCustomFont) inflate.findViewById(R.id.tv_duplicate)).setText(this.mResources.getString(R.string.duplicate));
        ((TextCustomFont) inflate.findViewById(R.id.tv_delete)).setText(this.mResources.getString(R.string.delete));
        int[] iArr = new int[2];
    ...
    private void initRv() {
        ...
        if (all != null && !all.isEmpty()) {
            ...
            Collections.sort(arrayList, new Comparator<Template>() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.7
            ...
            recyclerView.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.8
                @Override // java.lang.Runnable
                public void run() {
                    int screenWidth = (int) (ScreenUtils.getScreenWidth(WorkUserActivity.this) * 0.3f);
                    WorkUserActivity.this.workUserAdapter = new WorkUserAdapter(AppUtils.getAppVersionName(WorkUserActivity.this), arrayList, WorkUserActivity.this.iWorkUserCallback, screenWidth, screenWidth);
                    recyclerView.setLayoutManager(new LinearLayoutManager(WorkUserActivity.this, 1, false));
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setItemAnimator(null);
                    recyclerView.setAdapter(WorkUserActivity.this.workUserAdapter);
                }
            });
        }
        ButtonCustomFont buttonCustomFont = (ButtonCustomFont) findViewById(R.id.btn_to_studio);
        buttonCustomFont.setText(this.mResources.getString(R.string.create_video));
        buttonCustomFont.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Intent intent = new Intent(WorkUserActivity.this, (Class<?>) EngineActivity.class);
                intent.addFlags(65536);
    ...
    public void dialog(final int i, final Template template, final Uri uri) {
        ...
        buttonCustomFont.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.11
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
                    if (uri != null) {
                    ...
                    WorkUserActivity.this.workUserAdapter.remove(i);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                if (WorkUserActivity.this.popupWindow != null) {
        ...
        buttonCustomFont2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.WorkUserActivity.12
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                WorkUserActivity.this.dialog.dismiss();
            }
