...
public class GalleryPickerVideo extends Base {
    ...
    private GalleryVideoAdapters galleryPickerAdapters;
    private boolean isUpdate;
    private LinearLayout layoutSetting;
    private Resources mResources;
    private RecyclerView rv_explore;
    private VideoItem videoItem;
    private OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.1
    ...
    private IPicker iPicker = new IPicker() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.2
    ...
    private ExploreAdapters.IExplore iExplore = new ExploreAdapters.IExplore() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.3
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo$$ExternalSyntheticLambda0
        ...
        this.btnDone.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.4
    ...
    private void setSetting(boolean z) {
        ...
        this.layoutSetting.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private void initFolder() {
        ...
        this.btnExplore.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        new Thread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.7
            ...
            public void run() {
                ...
                GalleryPickerVideo.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.7.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ...
                        GalleryPickerVideo.this.galleryPickerAdapters = new GalleryVideoAdapters(AppUtils.getAppVersionName(GalleryPickerVideo.this), GalleryPickerVideo.this.mResources, null, (int) (ScreenUtils.getScreenWidth(GalleryPickerVideo.this) * 0.3f), GalleryPickerVideo.this.iPicker);
                        GalleryPickerVideo.this.galleryPickerAdapters.addItems(arrayList2);
                        recyclerView.setAdapter(GalleryPickerVideo.this.galleryPickerAdapters);
                    }
                });
                String str13 = str11;
                ...
                GalleryPickerVideo.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.7.2
                    @Override // java.lang.Runnable
                    public void run() {
                        GalleryPickerVideo.this.galleryPickerAdapters.doneItems(arrayList2);
                        GalleryPickerVideo.this.galleryPickerAdapters.notifyDataSetChanged();
                        ...
                        GalleryPickerVideo.this.rv_explore.setAdapter(new ExploreAdapters(arrayList, (int) (ScreenUtils.getScreenWidth(GalleryPickerVideo.this) * 0.2f), GalleryPickerVideo.this.iExplore, GalleryPickerVideo.this.btnExplore.getText().toString()));
    ...
    private void initViews() {
        findViewById(R.id.btn_onBack).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.GalleryPickerVideo.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                GalleryPickerVideo.this.finish();
            }
