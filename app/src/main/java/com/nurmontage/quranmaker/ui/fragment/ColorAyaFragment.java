...
public class ColorAyaFragment extends Fragment {
    ...
    private ColorAdapter.IColor iColor = new ColorAdapter.IColor() { // from class: com.nurmontage.quranmaker.ui.fragment.ColorAyaFragment.2
    ...
    private void setupPresetButtons(View view) {
        ...
        for (final int i2 = 0; i2 < 4; i2++) {
            textViewArr[i2].setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ColorAyaFragment$$ExternalSyntheticLambda0
    ...
    /* renamed from: lambda$setupPresetButtons$0$com-nurmontage-quranmaker-ui-fragment-ColorAyaFragment, reason: not valid java name */
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditEntityCallback != null && this.entity_select != null && this.resources != null) {
            ...
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ColorAyaFragment.1
                @Override // android.view.View.OnClickListener
