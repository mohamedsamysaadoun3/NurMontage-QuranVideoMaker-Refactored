...
import com.nurmontage.quranmaker.ui.adapter.TransitionEntityAdapters;
...
public class EffectAyaFragment extends Fragment {
    ...
    private TransitionEntityAdapters transitionEntityAdapters;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.resources != null && (iTransition = this.iTransition) != null) {
            ...
            tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectAyaFragment.1
            ...
            this.seekBarDuration.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectAyaFragment.2
            ...
            this.btn_unEffect.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectAyaFragment.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EffectAyaFragment.this.transitionEntityAdapters.isHaveSelect()) {
                        EffectAyaFragment.this.iTransition.remove(EffectAyaFragment.this.tab_selected, EffectAyaFragment.this.entityQuranTimeline);
                        EffectAyaFragment.this.transitionEntityAdapters.unselect();
            ...
            root.findViewById(R.id.btn_close).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectAyaFragment.4
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EffectAyaFragment.this.iTransition != null) {
            ...
            this.btnApplyAll.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectAyaFragment.5
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EffectAyaFragment.this.iTransition != null) {
            ...
            root.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectAyaFragment.6
                @Override // java.lang.Runnable
                public void run() {
                    int i;
                    List<TransitionEntityAdapters.TransitionItem> inTransition = EffectAyaFragment.this.getInTransition();
                    ...
                    int i2 = i;
                    EffectAyaFragment.this.transitionEntityAdapters = new TransitionEntityAdapters(BillingPreferences.isSubscribed(EffectAyaFragment.this.getContext()), EffectAyaFragment.this.iTransition, inTransition, i2, EffectAyaFragment.this.entityQuranTimeline);
                    EffectAyaFragment.this.recyclerView.setAdapter(EffectAyaFragment.this.transitionEntityAdapters);
                    EffectAyaFragment effectAyaFragment2 = EffectAyaFragment.this;
                    effectAyaFragment2.scroll(effectAyaFragment2.transitionEntityAdapters.getSelect());
                }
            });
        }
        return root;
    ...
    public int getIndex(List<TransitionEntityAdapters.TransitionItem> list, String str) {
    ...
    public void loadTransition(int i) {
        this.index = -1;
        if (i == 0) {
            List<TransitionEntityAdapters.TransitionItem> inTransition = getInTransition();
            Transition transition = this.transition;
            if (transition != null) {
                if (transition.isIn()) {
        ...
        if (i == 1) {
            List<TransitionEntityAdapters.TransitionItem> outTransition = getOutTransition();
    ...
    public List<TransitionEntityAdapters.TransitionItem> getInTransition() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new TransitionEntityAdapters.TransitionItem(TransitionType.FADE_IN.getValue(), R.drawable.ic_linear_gradient, 0));
        arrayList.add(new TransitionEntityAdapters.TransitionItem(TransitionType.SLIDE_TO_RIGHT.getValue(), R.drawable.ic_btn_back, Angle.LEFT));
        arrayList.add(new TransitionEntityAdapters.TransitionItem(TransitionType.SLIDE_TO_LEFT.getValue(), R.drawable.ic_btn_back, 0));
        return arrayList;
    }

    private List<TransitionEntityAdapters.TransitionItem> getOutTransition() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new TransitionEntityAdapters.TransitionItem(TransitionType.FADE_OUT.getValue(), R.drawable.ic_linear_gradient, 0));
        arrayList.add(new TransitionEntityAdapters.TransitionItem(TransitionType.SLIDE_TO_RIGHT.getValue(), R.drawable.ic_btn_back, Angle.LEFT));
        arrayList.add(new TransitionEntityAdapters.TransitionItem(TransitionType.SLIDE_TO_LEFT.getValue(), R.drawable.ic_btn_back, 0));
        return arrayList;
    }
