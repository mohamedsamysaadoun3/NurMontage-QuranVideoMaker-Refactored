...
import com.nurmontage.quranmaker.ui.fragment.RatingBottomSheetDialog;
...
public class VideoViewActivity extends Base {
    ...
    private String mUri;
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.1
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity$$ExternalSyntheticLambda0
        ...
        if (getIntent() != null) {
            ...
            if (data != null) {
                ...
                imageView.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.2
                ...
                this.videoView.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.3
        ...
        findViewById(R.id.btn_tuffah).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        findViewById(R.id.btn_home).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        TextCustomFont textCustomFont = (TextCustomFont) findViewById(R.id.tv_share);
        Resources resources = this.mResources;
        if (resources != null) {
            textCustomFont.setText(resources.getString(R.string.just_share));
        }
        findViewById(R.id.btn_share).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                String format;
                try {
                    if (!Utils.isProbablyArabic(VideoViewActivity.this.reader)) {
        ...
        findViewById(R.id.btn_on_back).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                VideoViewActivity.this.toStudio();
            }
        ...
        findViewById(R.id.btn_help).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public void dialogRate() {
        ...
        ((TextCustomFontBold) inflate.findViewById(R.id.tv_tittle)).setText(this.mResources.getString(R.string.how_many_stars));
        ButtonCustomFont buttonCustomFont = (ButtonCustomFont) inflate.findViewById(R.id.btn_rate);
        buttonCustomFont.setText(this.mResources.getString(R.string.rate_now));
        buttonCustomFont.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
        ...
        ButtonCustomFont buttonCustomFont2 = (ButtonCustomFont) inflate.findViewById(R.id.btn_rate_not_now);
        buttonCustomFont2.setText(this.mResources.getString(R.string.later));
        buttonCustomFont2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoViewActivity.10
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
