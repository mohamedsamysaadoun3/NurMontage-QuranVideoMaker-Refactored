...
import com.nurmontage.quranmaker.ui.adapter.GradientAdapter;
import com.nurmontage.quranmaker.common.Common;
import com.nurmontage.quranmaker.databinding.FragmentColorsBinding;
...
public class GradientFragment extends Fragment {
    ...
    private GradientAdapter.IColor iColor = new GradientAdapter.IColor() { // from class: com.nurmontage.quranmaker.ui.fragment.GradientFragment.2
        @Override // com.nurmontage.quranmaker.ui.adapter.GradientAdapter.IColor
    ...
    private TextCustomFont tv_angle;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.adapter = new GradientAdapter(this.iColor, Common.getListGradientColor(), BillingPreferences.isSubscribed(getContext()), this.index);
        this.recyclerView.setLayoutManager(new LinearLayoutManager(getContext(), 0, false));
        this.recyclerView.setItemAnimator(null);
        this.recyclerView.setHasFixedSize(true);
        this.recyclerView.setAdapter(this.adapter);
        this.gradient = this.adapter.getSelect();
        this.tv_angle = (TextCustomFont) root.findViewById(R.id.tv_angle);
        ...
        this.seekBar_angle.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.GradientFragment.1
