...
public class EditBismilahEntityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditEntityCallback != null && this.resources != null) {
            ...
            root.findViewById(R.id.btn_color).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditBismilahEntityFragment.1
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditBismilahEntityFragment.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditBismilahEntityFragment.this.iEditEntityCallback != null) {
            ...
            TextCustomFont textCustomFont = (TextCustomFont) root.findViewById(R.id.tv_from_now);
            this.tv_from_now = textCustomFont;
            textCustomFont.setText(this.resources.getString(R.string.from_now));
            ((TextCustomFont) root.findViewById(R.id.tv_from_the_start)).setText(this.resources.getString(R.string.from_the_start));
            TextCustomFont textCustomFont2 = (TextCustomFont) root.findViewById(R.id.tv_until_now);
            this.tv_until_now = textCustomFont2;
            textCustomFont2.setText(this.resources.getString(R.string.until_now));
            ...
            linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditBismilahEntityFragment.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditBismilahEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_from_the_start).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditBismilahEntityFragment.4
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditBismilahEntityFragment.this.iEditEntityCallback != null) {
            ...
            linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditBismilahEntityFragment.5
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditBismilahEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_until_the_end).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditBismilahEntityFragment.6
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditBismilahEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_anim).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditBismilahEntityFragment.7
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditBismilahEntityFragment.this.iEditEntityCallback != null) {
