...
import com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast;
...
import com.nurmontage.quranmaker.ui.adapter.FeaturesAdapter;
...
public class ProVersionActivityLast extends Base implements PurchasesUpdatedListener {
    ...
    private ButtonCustomFont btnContinue;
    private RelativeLayout btn_foreiver;
    private RelativeLayout btn_month;
    private TextCustomFont btn_restore;
    ...
    private TextCustomFont tv_foreiver;
    private TextCustomFont tv_month;
    private TextCustomFont tv_price_foreiver;
    private TextCustomFont tv_price_month;
    private TextCustomFont tv_price_year;
    private TextCustomFont tv_year;
    private int color_select = -206036;
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.1
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$$ExternalSyntheticLambda2
        ...
        findViewById(R.id.btn_on_back).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.2
        ...
        this.btn_restore.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
        ...
        this.tv_foreiver = (TextCustomFont) findViewById(R.id.tv_foreiver);
        this.tv_price_year = (TextCustomFont) findViewById(R.id.tv_price_year);
        this.tv_price_foreiver = (TextCustomFont) findViewById(R.id.tv_price_foreiver);
        ...
        this.btn_foreiver.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.btn_year.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        this.btn_month.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        ButtonCustomFont buttonCustomFont = (ButtonCustomFont) findViewById(R.id.btn_continue);
        this.btnContinue = buttonCustomFont;
        buttonCustomFont.setText(this.mResources.getString(R.string.subscribe_now));
        this.btnContinue.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
    ...
    private void initBtnHelp() {
        findViewById(R.id.btn_contact).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private void initImgFeatures() {
        findViewById(R.id.ytb_layout).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        if (LocaleHelper.getLanguage(this).equals("ar")) {
            TextCustomFont textCustomFont = (TextCustomFont) findViewById(R.id.tv_pro_ar);
            textCustomFont.setVisibility(0);
            textCustomFont.setText(this.mResources.getString(R.string.pro));
            TextCustomFont textCustomFont2 = (TextCustomFont) findViewById(R.id.tv_free_ar);
            textCustomFont2.setVisibility(0);
            textCustomFont2.setText(this.mResources.getString(R.string.free));
            findViewById(R.id.tv_pro).setVisibility(8);
        } else {
            TextCustomFont textCustomFont3 = (TextCustomFont) findViewById(R.id.tv_pro);
            textCustomFont3.setVisibility(0);
            textCustomFont3.setText(this.mResources.getString(R.string.pro));
            TextCustomFont textCustomFont4 = (TextCustomFont) findViewById(R.id.tv_free);
            textCustomFont4.setVisibility(0);
            textCustomFont4.setText(this.mResources.getString(R.string.free));
        }
        ((TextCustomFont) findViewById(R.id.tv_tittle_billing)).setText(this.mResources.getString(R.string.unlock_premium));
    ...
    public void startBillingConnection() {
        this.billingClient.startConnection(new BillingClientStateListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.10
    ...
    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$11, reason: invalid class name */
    class AnonymousClass11 implements ProductDetailsResponseListener {
        ...
        public void onProductDetailsResponse(BillingResult billingResult, List<ProductDetails> list) {
            ...
            for (final ProductDetails productDetails : list) {
                ...
                ProVersionActivityLast.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$11$$ExternalSyntheticLambda0
        ...
        /* renamed from: lambda$onProductDetailsResponse$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivityLast$11, reason: not valid java name */
    ...
    private void queryUserPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$$ExternalSyntheticLambda3
    ...
    /* renamed from: lambda$queryUserPurchases$1$com-nurmontage-quranmaker-ui-activity-ProVersionActivityLast, reason: not valid java name */
    ...
    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$12, reason: invalid class name */
    class AnonymousClass12 implements ProductDetailsResponseListener {
        ...
        public void onProductDetailsResponse(BillingResult billingResult, List<ProductDetails> list) {
            ...
            for (final ProductDetails productDetails : list) {
                ProVersionActivityLast.this.productDetailsMap.put(productDetails.getProductId(), productDetails);
                ProVersionActivityLast.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$12$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        /* renamed from: lambda$onProductDetailsResponse$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivityLast$12, reason: not valid java name */
    ...
    public void queryPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$$ExternalSyntheticLambda1
            @Override // com.android.billingclient.api.PurchasesResponseListener
            public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
    ...
    /* renamed from: lambda$queryPurchases$2$com-nurmontage-quranmaker-ui-activity-ProVersionActivityLast, reason: not valid java name */
    ...
    private void handlePurchase(Purchase purchase) {
        if (purchase.getPurchaseState() == 1) {
            ...
            this.billingClient.acknowledgePurchase(AcknowledgePurchaseParams.newBuilder().setPurchaseToken(purchase.getPurchaseToken()).build(), new AcknowledgePurchaseResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$$ExternalSyntheticLambda0
        ...
        if (purchase.getPurchaseState() == 2) {
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.13
                @Override // java.lang.Runnable
                public void run() {
            ...
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.14
                @Override // java.lang.Runnable
                public void run() {
    ...
    private void thnks() {
        try {
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.15
                @Override // java.lang.Runnable
                public void run() {
                    ...
                    ((TextCustomFont) ProVersionActivityLast.this.findViewById(R.id.tv_thanks)).setText(ProVersionActivityLast.this.mResources.getString(R.string.thanks_hint));
                    ...
                    proVersionActivityLast.btnContinue = (ButtonCustomFont) proVersionActivityLast.findViewById(R.id.btn_done);
                    ProVersionActivityLast.this.btnContinue.setText(ProVersionActivityLast.this.mResources.getString(R.string.done));
                    ProVersionActivityLast.this.btnContinue.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.15.1
                        @Override // android.view.View.OnClickListener
                        public void onClick(View view) {
                            ProVersionActivityLast.this.onBackPressedCallback.handleOnBackPressed();
                        }
                    });
                    ProVersionActivityLast.this.featuresAdapter.setSubscribe(true);
    ...
    public void checkUserSubscriptionStatus() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("subs").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.16
            @Override // com.android.billingclient.api.PurchasesResponseListener
    ...
    public void checkInAppPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast$$ExternalSyntheticLambda4
            @Override // com.android.billingclient.api.PurchasesResponseListener
            public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
    ...
    /* renamed from: lambda$checkInAppPurchases$4$com-nurmontage-quranmaker-ui-activity-ProVersionActivityLast, reason: not valid java name */
    /* synthetic */ void m784x97745e13(BillingResult billingResult, List list) {
        ...
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.17
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void handleInAppPurchases(List<Purchase> list) {
        ...
        while (it.hasNext()) {
            if (it.next().getPurchaseState() == 1) {
                runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.18
                    @Override // java.lang.Runnable
                    public void run() {
                        ProVersionActivityLast.this.hideProgressFragment();
                    }
    ...
    private void handleNoPurchases() {
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.19
            @Override // java.lang.Runnable
            public void run() {
                ProVersionActivityLast.this.hideProgressFragment();
    ...
    private void playVibration() {
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityLast.20
            @Override // java.lang.Runnable
            public void run() {
