...
public class BgAdapterL extends RecyclerView.Adapter<ViewHolder> {
    ...
    public BgAdapterL(String str, ChangeBgFragment.IChangeBgCallback iChangeBgCallback, List<BgItem> list, int i) {
        this.images = list;
        this.size = i;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.adapter.BgAdapterL.ViewHolder.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    if (BgAdapterL.this.iBgCallback != null) {
                        BgAdapterL.this.selected = ViewHolder.this.getAdapterPosition();
                        BgAdapterL.this.iBgCallback.onAdd((BgItem) BgAdapterL.this.images.get(ViewHolder.this.getAdapterPosition()));
                    }
                }
            });
        }
