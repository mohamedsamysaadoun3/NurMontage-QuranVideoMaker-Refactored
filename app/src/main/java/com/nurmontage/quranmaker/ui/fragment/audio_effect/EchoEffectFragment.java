...
import com.nurmontage.quranmaker.databinding.FragmentEchoEffectBinding;
...
public class EchoEffectFragment extends Fragment {
    ...
    private TextCustomFont tv_hint_delay;
    private TextCustomFont tv_hint_repeat;
    private TextCustomFont tv_hint_volume;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.entityAudio != null && this.iEchoCallback != null) {
            this.tv_hint_delay = (TextCustomFont) root.findViewById(R.id.tv_delay_size);
            this.tv_hint_repeat = (TextCustomFont) root.findViewById(R.id.tv_repeat_size);
            this.tv_hint_volume = (TextCustomFont) root.findViewById(R.id.tv_volume_size);
            ...
            this.delaySeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EchoEffectFragment.1
            ...
            this.repeatSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EchoEffectFragment.2
                @Override // android.widget.SeekBar.OnSeekBarChangeListener
            ...
            this.volumeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EchoEffectFragment.3
                @Override // android.widget.SeekBar.OnSeekBarChangeListener
            ...
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EchoEffectFragment$$ExternalSyntheticLambda0
            ...
            imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EchoEffectFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    EchoEffectFragment.this.m1167x33133e86(view);
                }
            });
            root.findViewById(R.id.btn_appl_all).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EchoEffectFragment$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    /* renamed from: lambda$onCreateView$0$com-nurmontage-quranmaker-ui-fragment-audio_effect-EchoEffectFragment, reason: not valid java name */
    /* synthetic */ void m1166xfa32dde7(View view) {
        done();
    }

    /* renamed from: lambda$onCreateView$1$com-nurmontage-quranmaker-ui-fragment-audio_effect-EchoEffectFragment, reason: not valid java name */
    /* synthetic */ void m1167x33133e86(View view) {
        previewAudio();
    }

    /* renamed from: lambda$onCreateView$2$com-nurmontage-quranmaker-ui-fragment-audio_effect-EchoEffectFragment, reason: not valid java name */
