...
public class VideoPlayerActivity extends Base {
    ...
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.VideoPlayerActivity.1
    ...
    private void initializePlayer() {
        ...
        this.player.prepare();
        this.player.play();
        this.player.addListener(new Player.Listener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoPlayerActivity.2
    ...
    private void setupButtons() {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoPlayerActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VideoPlayerActivity.this.m920x289c8f84(view);
            }
        });
        imageButton2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoPlayerActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VideoPlayerActivity.this.m921x28262985(view);
            }
        });
        this.btnPlay.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.VideoPlayerActivity.3
            @Override // android.view.View.OnClickListener
    ...
    /* renamed from: lambda$setupButtons$0$com-nurmontage-quranmaker-ui-activity-VideoPlayerActivity, reason: not valid java name */
    /* synthetic */ void m920x289c8f84(View view) {
        releasePlayer();
        returnAct();
    }

    /* renamed from: lambda$setupButtons$1$com-nurmontage-quranmaker-ui-activity-VideoPlayerActivity, reason: not valid java name */
