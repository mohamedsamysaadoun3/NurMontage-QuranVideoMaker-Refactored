...
import com.nurmontage.quranmaker.ui.adapter.IpadAdapter;
import com.nurmontage.quranmaker.constant.IpadType;
import com.nurmontage.quranmaker.databinding.FragmentEditIpadBinding;
...
public class EditIpadFragment extends Fragment {
    ...
    private IpadAdapter ipadAdapter;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.ipadAdapter = new IpadAdapter(BillingPreferences.isSubscribed(getContext()), posSelect, this.ipadType, this.iIpadEditCallback, arrayList, this.isGlass);
        ...
        this.rv_type.setAdapter(this.ipadAdapter);
        if (posSelect > 3) {
            try {
        ...
        root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditIpadFragment.1
    ...
    public void scrollToSelectedPosition() {
        try {
            ...
            if (linearLayoutManager != null) {
                linearLayoutManager.scrollToPositionWithOffset(this.ipadAdapter.getPos_select(), (this.rv_type.getWidth() / 2) - 50);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void addCustomViewToTab(TabLayout.Tab tab) {
        ...
        ((TextCustomFont) inflate.findViewById(R.id.name)).setText(tab.getText().toString());
    ...
    private void initTab(View view) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditIpadFragment.2
