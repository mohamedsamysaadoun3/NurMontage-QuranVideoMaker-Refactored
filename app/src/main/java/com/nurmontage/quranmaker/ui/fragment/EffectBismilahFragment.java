...
import com.nurmontage.quranmaker.ui.adapter.TransitionBismilahAdapters;
import com.nurmontage.quranmaker.constant.TransitionType;
import com.nurmontage.quranmaker.databinding.FragmentEffectAyaBinding;
...
public class EffectBismilahFragment extends Fragment {
    ...
    private TransitionBismilahAdapters transitionEntityAdapters;
    private FragmentEffectAyaBinding transitionEntityBinding;
    private TextCustomFont tvDuration;
    private TextCustomFont tv_apply_all;
    ...
    private void addCustomViewToTab(TabLayout.Tab tab) {
        ...
        TextCustomFont textCustomFont = (TextCustomFont) inflate.findViewById(R.id.name);
        inflate.findViewById(R.id.icon).setVisibility(8);
        textCustomFont.setText(tab.getText().toString());
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.resources != null && (iTransition = this.iTransition) != null) {
            ...
            this.tvDuration = (TextCustomFont) root.findViewById(R.id.status_duration);
            ...
            tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectBismilahFragment.1
            ...
            this.seekBarDuration.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectBismilahFragment.2
            ...
            this.btn_unEffect.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectBismilahFragment.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EffectBismilahFragment.this.transitionEntityAdapters.isHaveSelect()) {
                        ...
                        EffectBismilahFragment.this.transitionEntityAdapters.unselect();
            ...
            root.findViewById(R.id.btn_close).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectBismilahFragment.4
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EffectBismilahFragment.this.iTransition != null) {
            ...
            this.tv_apply_all = (TextCustomFont) root.findViewById(R.id.tv_apply_all);
            ...
            this.btnApplyAll.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectBismilahFragment.5
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EffectBismilahFragment.this.iTransition != null) {
            ...
            root.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.fragment.EffectBismilahFragment.6
                @Override // java.lang.Runnable
                public void run() {
                    int i;
                    List<TransitionBismilahAdapters.TransitionItem> inTransition = EffectBismilahFragment.this.getInTransition();
                    ...
                    EffectBismilahFragment.this.transitionEntityAdapters = new TransitionBismilahAdapters(EffectBismilahFragment.this.iTransition, inTransition, i, EffectBismilahFragment.this.entityQuranTimeline);
                    EffectBismilahFragment.this.recyclerView.setAdapter(EffectBismilahFragment.this.transitionEntityAdapters);
                    EffectBismilahFragment effectBismilahFragment2 = EffectBismilahFragment.this;
                    effectBismilahFragment2.scroll(effectBismilahFragment2.transitionEntityAdapters.getSelect());
                }
            });
        }
        return root;
    ...
    public int getIndex(List<TransitionBismilahAdapters.TransitionItem> list, String str) {
    ...
    public void loadTransition(int i) {
        this.index = -1;
        if (i == 0) {
            List<TransitionBismilahAdapters.TransitionItem> inTransition = getInTransition();
            Transition transition = this.transition;
            if (transition != null) {
                if (transition.isIn()) {
            ...
            this.transitionEntityAdapters.update(inTransition, "in", this.index);
            scroll(this.index);
        ...
        if (i == 1) {
            List<TransitionBismilahAdapters.TransitionItem> outTransition = getOutTransition();
            ...
            this.transitionEntityAdapters.update(outTransition, "out", this.index);
            scroll(this.index);
    ...
    public List<TransitionBismilahAdapters.TransitionItem> getInTransition() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new TransitionBismilahAdapters.TransitionItem(TransitionType.FADE_IN.getValue(), R.drawable.ic_linear_gradient, 0));
        arrayList.add(new TransitionBismilahAdapters.TransitionItem(TransitionType.SLIDE_TO_RIGHT.getValue(), R.drawable.ic_btn_back, Angle.LEFT));
        arrayList.add(new TransitionBismilahAdapters.TransitionItem(TransitionType.SLIDE_TO_LEFT.getValue(), R.drawable.ic_btn_back, 0));
        return arrayList;
    }

    private List<TransitionBismilahAdapters.TransitionItem> getOutTransition() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new TransitionBismilahAdapters.TransitionItem(TransitionType.FADE_OUT.getValue(), R.drawable.ic_linear_gradient, 0));
        arrayList.add(new TransitionBismilahAdapters.TransitionItem(TransitionType.SLIDE_TO_RIGHT.getValue(), R.drawable.ic_btn_back, Angle.LEFT));
        arrayList.add(new TransitionBismilahAdapters.TransitionItem(TransitionType.SLIDE_TO_LEFT.getValue(), R.drawable.ic_btn_back, 0));
        return arrayList;
    }
