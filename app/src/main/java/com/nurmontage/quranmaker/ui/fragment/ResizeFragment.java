...
import com.nurmontage.quranmaker.common.DataDimension;
import com.nurmontage.quranmaker.databinding.FragmentResizeBinding;
...
public class ResizeFragment extends Fragment {
    ...
    private DimensionAdapters adabter;
    private FragmentResizeBinding binding;
    private DimensionAdapters.IDimensionCallback iDimensionCallback;
    ...
    public static ResizeFragment getInstance(DimensionAdapters.IDimensionCallback iDimensionCallback, Resources resources, String str) {
        if (instance == null) {
    ...
    public ResizeFragment(DimensionAdapters.IDimensionCallback iDimensionCallback, Resources resources, String str) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.res != null && this.iDimensionCallback != null) {
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ResizeFragment.1
            ...
            DimensionAdapters dimensionAdapters = new DimensionAdapters(aLl, this.iDimensionCallback, getListDimension(getActivity(), aLl), this.posSelectResize);
            this.adabter = dimensionAdapters;
            this.recyclerView.setAdapter(dimensionAdapters);
