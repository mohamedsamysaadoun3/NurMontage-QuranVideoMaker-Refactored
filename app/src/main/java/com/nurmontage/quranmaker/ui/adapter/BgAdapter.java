...
public class BgAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.adapter.BgAdapter$ViewHolder$$ExternalSyntheticLambda0
        ...
        /* renamed from: lambda$new$0$com-nurmontage-quranmaker-ui-adapter-BgAdapter$ViewHolder, reason: not valid java name */
