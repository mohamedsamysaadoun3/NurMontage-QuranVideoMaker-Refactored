...
public class WorkUserAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public WorkUserAdapter(String str, List<Template> list, IWorkUserCallback iWorkUserCallback, int i, int i2) {
        this.images = list;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            this.btn_menu.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.adapter.WorkUserAdapter.ViewHolder.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    if (WorkUserAdapter.this.iWorkUserCallback != null) {
                        WorkUserAdapter.this.iWorkUserCallback.toMenu((Template) WorkUserAdapter.this.images.get(ViewHolder.this.getAdapterPosition()), view2, ViewHolder.this.getAdapterPosition());
                    }
                }
            });
            view.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.adapter.WorkUserAdapter.ViewHolder.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    if (WorkUserAdapter.this.iWorkUserCallback != null) {
                        WorkUserAdapter.this.iWorkUserCallback.onClick((Template) WorkUserAdapter.this.images.get(ViewHolder.this.getAdapterPosition()));
                    }
                }
            });
        }
