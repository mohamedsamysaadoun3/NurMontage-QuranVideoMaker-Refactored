...
public class CropView extends View {
    ...
    private void startHintAnimation() {
        ...
        this.hintAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.nurmontage.quranmaker.ui.view.CropView.1
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L87:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nurmontage.quranmaker.ui.view.CropView.onTouchEvent(android.view.MotionEvent):boolean");
    }
}
