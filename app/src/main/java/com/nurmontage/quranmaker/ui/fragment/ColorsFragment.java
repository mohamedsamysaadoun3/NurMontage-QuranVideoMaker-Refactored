...
public class ColorsFragment extends Fragment {
    ...
    private ColorAdapter.IColor iColor = new ColorAdapter.IColor() { // from class: com.nurmontage.quranmaker.ui.fragment.ColorsFragment.1
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.adapter = new ColorAdapter(this.iColor, Common.MUSLIM_COLORS, this.index);
