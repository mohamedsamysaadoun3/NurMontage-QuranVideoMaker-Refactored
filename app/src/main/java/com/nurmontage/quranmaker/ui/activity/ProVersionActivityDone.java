...
import com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone;
...
public class ProVersionActivityDone extends Base implements PurchasesUpdatedListener {
    ...
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.1
    ...
    private final Runnable autoScrollRunnable = new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.10
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$$ExternalSyntheticLambda5
        ...
        findViewById(R.id.btn_on_back).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.2
    ...
    private void showFeatures() {
        try {
            ...
            inflate.findViewById(R.id.dialog_no).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
    ...
    private void initBtnHelp(boolean z) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public void startBillingConnection() {
        this.billingClient.startConnection(new BillingClientStateListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.5
    ...
    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$6, reason: invalid class name */
    class AnonymousClass6 implements ProductDetailsResponseListener {
        ...
        public void onProductDetailsResponse(BillingResult billingResult, List<ProductDetails> list) {
            ...
            for (final ProductDetails productDetails : list) {
                ...
                ProVersionActivityDone.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$6$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
        ...
        /* renamed from: lambda$onProductDetailsResponse$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivityDone$6, reason: not valid java name */
    ...
    private void queryUserPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$$ExternalSyntheticLambda1
    ...
    /* renamed from: lambda$queryUserPurchases$1$com-nurmontage-quranmaker-ui-activity-ProVersionActivityDone, reason: not valid java name */
    ...
    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$7, reason: invalid class name */
    class AnonymousClass7 implements ProductDetailsResponseListener {
        ...
        public void onProductDetailsResponse(BillingResult billingResult, List<ProductDetails> list) {
            ...
            for (final ProductDetails productDetails : list) {
                ProVersionActivityDone.this.productDetailsMap.put(productDetails.getProductId(), productDetails);
                ProVersionActivityDone.this.runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$7$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        /* renamed from: lambda$onProductDetailsResponse$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivityDone$7, reason: not valid java name */
    ...
    public void queryPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$$ExternalSyntheticLambda4
            @Override // com.android.billingclient.api.PurchasesResponseListener
            public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
    ...
    /* renamed from: lambda$queryPurchases$2$com-nurmontage-quranmaker-ui-activity-ProVersionActivityDone, reason: not valid java name */
    ...
    private void handlePurchase(Purchase purchase) {
        if (purchase.getPurchaseState() == 1) {
            ...
            this.billingClient.acknowledgePurchase(AcknowledgePurchaseParams.newBuilder().setPurchaseToken(purchase.getPurchaseToken()).build(), new AcknowledgePurchaseResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$$ExternalSyntheticLambda2
        ...
        if (purchase.getPurchaseState() == 2) {
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.8
                @Override // java.lang.Runnable
                public void run() {
            ...
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.9
                @Override // java.lang.Runnable
                public void run() {
    ...
    private void thnks() {
        ((TextCustomFont) findViewById(R.id.tv_thanks)).setText(this.mResources.getString(R.string.thanks_hint));
        initBtnHelp(true);
        explode();
    }

    /* renamed from: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$11, reason: invalid class name */
    class AnonymousClass11 implements Runnable {
        ...
        public void run() {
            ...
            ProVersionActivityDone.this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.11.1
            ...
            ProVersionActivityDone.this.recyclerView.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$11$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
        ...
        /* renamed from: lambda$run$0$com-nurmontage-quranmaker-ui-activity-ProVersionActivityDone$11, reason: not valid java name */
    ...
    public void checkUserSubscriptionStatus() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("subs").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.12
            @Override // com.android.billingclient.api.PurchasesResponseListener
    ...
    public void checkInAppPurchases() {
        this.billingClient.queryPurchasesAsync(QueryPurchasesParams.newBuilder().setProductType("inapp").build(), new PurchasesResponseListener() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone$$ExternalSyntheticLambda3
            @Override // com.android.billingclient.api.PurchasesResponseListener
            public final void onQueryPurchasesResponse(BillingResult billingResult, List list) {
    ...
    /* renamed from: lambda$checkInAppPurchases$4$com-nurmontage-quranmaker-ui-activity-ProVersionActivityDone, reason: not valid java name */
    /* synthetic */ void m737x9770eeff(BillingResult billingResult, List list) {
        ...
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.13
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void handleNoPurchases() {
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.14
            @Override // java.lang.Runnable
            public void run() {
                ProVersionActivityDone.this.hideProgressFragment();
    ...
    private void playVibration() {
        runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ProVersionActivityDone.15
            @Override // java.lang.Runnable
            public void run() {
