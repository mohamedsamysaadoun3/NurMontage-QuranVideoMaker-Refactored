...
import com.nurmontage.quranmaker.util.audio.AudioUploadHelper;
...
public class ShareWithMeActivity extends Base {
    ...
    private void processVideo(Uri uri) {
        ...
        FFmpegKit.executeAsync("-y -i \"" + absolutePath + "\" -vn -map 0:a? -c:a copy \"" + str + "\"", new FFmpegSessionCompleteCallback() { // from class: com.nurmontage.quranmaker.ui.activity.ShareWithMeActivity$$ExternalSyntheticLambda0
    ...
    /* renamed from: lambda$processVideo$3$com-nurmontage-quranmaker-ui-activity-ShareWithMeActivity, reason: not valid java name */
    /* synthetic */ void m876x79670e10(final String str, String str2, FFmpegSession fFmpegSession) {
        if (ReturnCode.isSuccess(fFmpegSession.getReturnCode())) {
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ShareWithMeActivity$$ExternalSyntheticLambda1
            ...
            FFmpegKit.executeAsync("-y -i \"" + str2 + "\" -vn -map 0:a? -c:a aac -b:a 192k \"" + str + "\"", new FFmpegSessionCompleteCallback() { // from class: com.nurmontage.quranmaker.ui.activity.ShareWithMeActivity$$ExternalSyntheticLambda2
                @Override // com.arthenica.ffmpegkit.FFmpegSessionCompleteCallback
    ...
    /* renamed from: lambda$processVideo$0$com-nurmontage-quranmaker-ui-activity-ShareWithMeActivity, reason: not valid java name */
    /* synthetic */ void m873x7aca400d(String str) {
        toEngine(Uri.parse(str), str);
    }

    /* renamed from: lambda$processVideo$2$com-nurmontage-quranmaker-ui-activity-ShareWithMeActivity, reason: not valid java name */
    /* synthetic */ void m875x79dd740f(final String str, FFmpegSession fFmpegSession) {
        if (ReturnCode.isSuccess(fFmpegSession.getReturnCode())) {
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ShareWithMeActivity$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
            ...
            runOnUiThread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.ShareWithMeActivity.1
                @Override // java.lang.Runnable
                public void run() {
    ...
    /* renamed from: lambda$processVideo$1$com-nurmontage-quranmaker-ui-activity-ShareWithMeActivity, reason: not valid java name */
