...
import com.nurmontage.quranmaker.ui.adapter.BgAdapter;
...
public class ChangeBgFragment extends Fragment {
    ...
    private void bindViews(View view) {
        ...
        if (this.res != null) {
            ((TextCustomFont) view.findViewById(R.id.tv_img)).setText(this.res.getString(R.string.image));
            ((TextCustomFont) view.findViewById(R.id.tv_video)).setText(this.res.getString(R.string.video));
        }
    }
    ...
    private void setupRecycler() {
        ...
        this.recyclerView.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda0
    ...
    private void setupButtons(View view) {
        view.findViewById(R.id.btn_add).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChangeBgFragment.this.m1077xacc46dfb(view2);
            }
        });
        view.findViewById(R.id.btn_close).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChangeBgFragment.this.m1078xd618c33c(view2);
            }
        });
        view.findViewById(R.id.btn_add_img).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChangeBgFragment.this.m1079xff6d187d(view2);
            }
        });
        view.findViewById(R.id.btn_add_video).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChangeBgFragment.this.m1080x28c16dbe(view2);
            }
        });
        view.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChangeBgFragment.this.m1081x5215c2ff(view2);
            }
        });
        view.findViewById(R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ChangeBgFragment$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
    ...
    /* renamed from: lambda$setupButtons$0$com-nurmontage-quranmaker-ui-fragment-ChangeBgFragment, reason: not valid java name */
    /* synthetic */ void m1077xacc46dfb(View view) {
        this.layoutAddVideo.setVisibility(0);
        this.layoutBgRv.setVisibility(4);
    }

    /* renamed from: lambda$setupButtons$1$com-nurmontage-quranmaker-ui-fragment-ChangeBgFragment, reason: not valid java name */
    /* synthetic */ void m1078xd618c33c(View view) {
        this.layoutAddVideo.setVisibility(8);
        this.layoutBgRv.setVisibility(0);
    }

    /* renamed from: lambda$setupButtons$2$com-nurmontage-quranmaker-ui-fragment-ChangeBgFragment, reason: not valid java name */
    ...
    /* renamed from: lambda$setupButtons$3$com-nurmontage-quranmaker-ui-fragment-ChangeBgFragment, reason: not valid java name */
    ...
    /* renamed from: lambda$setupButtons$4$com-nurmontage-quranmaker-ui-fragment-ChangeBgFragment, reason: not valid java name */
    ...
    /* renamed from: lambda$setupButtons$5$com-nurmontage-quranmaker-ui-fragment-ChangeBgFragment, reason: not valid java name */
    ...
    /* renamed from: lambda$setupButtons$6$com-nurmontage-quranmaker-ui-fragment-ChangeBgFragment, reason: not valid java name */
