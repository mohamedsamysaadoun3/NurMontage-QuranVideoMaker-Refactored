...
public class ColorS_NameFragment extends Fragment {
    ...
    private ColorAdapter.IColor iColor = new ColorAdapter.IColor() { // from class: com.nurmontage.quranmaker.ui.fragment.ColorS_NameFragment.2
    ...
    private void setupPresetButtons(View view) {
        ...
        for (final int i2 = 0; i2 < 4; i2++) {
            textViewArr[i2].setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ColorS_NameFragment$$ExternalSyntheticLambda0
    ...
    /* renamed from: lambda$setupPresetButtons$0$com-nurmontage-quranmaker-ui-fragment-ColorS_NameFragment, reason: not valid java name */
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditSName != null && this.entity_select != null && this.resources != null) {
            ...
            this.adapter = new ColorAdapter(this.iColor, Common.MUSLIM_AYA_COLORS, Utils.indexOf(Common.MUSLIM_AYA_COLORS, this.entity_select.getClrS_name()));
            ...
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.ColorS_NameFragment.1
                @Override // android.view.View.OnClickListener
