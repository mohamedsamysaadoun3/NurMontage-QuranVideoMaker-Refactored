...
import com.nurmontage.quranmaker.util.WordProcessor;
import com.nurmontage.quranmaker.ui.adapter.WordAyaAdapter;
...
public class TextEditActivity extends Base {
    ...
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.TextEditActivity.1
    ...
    private WordAyaAdapter wordAyaAdapter;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.TextEditActivity$$ExternalSyntheticLambda0
            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return TextEditActivity.lambda$onCreate$0(view, windowInsetsCompat);
            }
        });
        findViewById(R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.TextEditActivity.2
        ...
        buttonCustomFont.setText(getResources().getString(R.string.done));
        buttonCustomFont.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.TextEditActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public String getSelectedAya() {
        ...
        List<WordModel> list = this.wordAyaAdapter.getList();
        this.startIndex = -1;
        int i = 0;
    ...
    private void init(String str, String str2) {
        ...
        this.wordAyaAdapter = new WordAyaAdapter(wordProcessor.reverseInGroupsOfFour(arrayList));
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.rv);
        recyclerView.setLayoutManager(new GridLayoutManager(this, 4));
        recyclerView.setHasFixedSize(true);
        recyclerView.setItemAnimator(null);
        recyclerView.setAdapter(this.wordAyaAdapter);
    }
}
