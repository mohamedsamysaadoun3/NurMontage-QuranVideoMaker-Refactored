...
import com.nurmontage.quranmaker.databinding.FragmentFadeInOutBinding;
...
public class FadeInOutFragment extends Fragment {
    ...
    private TextCustomFont hint_fade_in;
    private TextCustomFont hint_fade_out;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.hint_fade_in = (TextCustomFont) root.findViewById(R.id.hint_fade_in);
        this.hint_fade_out = (TextCustomFont) root.findViewById(R.id.hint_fade_out);
        ...
        this.fadeInSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.FadeInOutFragment.1
        ...
        this.fadeOutSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.FadeInOutFragment.2
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onStartTrackingTouch(SeekBar seekBar) {
            }
        ...
        root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.FadeInOutFragment$$ExternalSyntheticLambda0
        ...
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.FadeInOutFragment$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FadeInOutFragment.this.m1176x5172de3d(view);
            }
        });
        root.findViewById(R.id.btn_appl_all).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.FadeInOutFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* renamed from: lambda$onCreateView$0$com-nurmontage-quranmaker-ui-fragment-audio_effect-FadeInOutFragment, reason: not valid java name */
    /* synthetic */ void m1175x60214ebc(View view) {
        done();
    }

    /* renamed from: lambda$onCreateView$1$com-nurmontage-quranmaker-ui-fragment-audio_effect-FadeInOutFragment, reason: not valid java name */
    /* synthetic */ void m1176x5172de3d(View view) {
        previewAudio();
    }

    /* renamed from: lambda$onCreateView$2$com-nurmontage-quranmaker-ui-fragment-audio_effect-FadeInOutFragment, reason: not valid java name */
