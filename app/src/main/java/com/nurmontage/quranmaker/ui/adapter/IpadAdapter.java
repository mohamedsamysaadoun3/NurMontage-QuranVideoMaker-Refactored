...
import com.nurmontage.quranmaker.model.IpadItem;
import java.util.List;

/* loaded from: classes2.dex */
public class IpadAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public IpadAdapter(boolean z, int i, int i2, EditIpadFragment.IIpadEditCallback iIpadEditCallback, List<IpadItem> list, boolean z2) {
        this.ipadItems = list;
        this.pos_select = i;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.adapter.IpadAdapter.ViewHolder.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    if (IpadAdapter.this.pos_select == ViewHolder.this.getAdapterPosition()) {
                        if (!IpadAdapter.this.isManyOption(ViewHolder.this.getAdapterPosition())) {
                            return;
                        }
                        IpadAdapter.this.isGlass = !IpadAdapter.this.isGlass;
                        IpadAdapter.this.ipadEditCallback.onGlassType(IpadAdapter.this.isGlass);
                    }
                    if (!IpadAdapter.this.isSubscribe && ViewHolder.this.getAdapterPosition() > 1) {
                        IpadAdapter.this.ipadEditCallback.onDialogPremium();
                        return;
                    }
                    if (IpadAdapter.this.ipadEditCallback != null) {
                        IpadItem ipadItem = (IpadItem) IpadAdapter.this.ipadItems.get(ViewHolder.this.getAdapterPosition());
                        IpadAdapter.this.notifyItemChanged(IpadAdapter.this.pos_select);
                        IpadAdapter.this.pos_select = ViewHolder.this.getAdapterPosition();
                        IpadAdapter.this.ipad_selected = ipadItem.getIpadType().ordinal();
                        IpadAdapter.this.notifyItemChanged(IpadAdapter.this.pos_select);
                        IpadAdapter.this.ipadEditCallback.onChangeType(IpadAdapter.this.ipad_selected);
                    }
                }
            });
        }
