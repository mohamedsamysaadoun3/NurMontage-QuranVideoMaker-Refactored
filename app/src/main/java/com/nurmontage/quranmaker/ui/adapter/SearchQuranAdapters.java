...
public class SearchQuranAdapters extends RecyclerView.Adapter<ViewHolder> {
    ...
    public SearchQuranAdapters(ISearchQuranCallback iSearchQuranCallback) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.adapter.SearchQuranAdapters$ViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    SearchQuranAdapters.ViewHolder.this.m1026xcfa7fc81(view2);
                }
            });
        }

        /* renamed from: lambda$new$0$com-nurmontage-quranmaker-ui-adapter-SearchQuranAdapters$ViewHolder, reason: not valid java name */
        /* synthetic */ void m1026xcfa7fc81(View view) {
            int bindingAdapterPosition = getBindingAdapterPosition();
            if (bindingAdapterPosition == -1) {
                return;
            }
            if (SearchQuranAdapters.this.minSelected == -1) {
                SearchQuranAdapters.this.minSelected = bindingAdapterPosition;
                SearchQuranAdapters.this.maxSelected = bindingAdapterPosition;
            } else if (bindingAdapterPosition < SearchQuranAdapters.this.minSelected) {
                SearchQuranAdapters.this.minSelected = bindingAdapterPosition;
            } else if (bindingAdapterPosition > SearchQuranAdapters.this.maxSelected) {
                SearchQuranAdapters.this.maxSelected = bindingAdapterPosition;
            } else {
                SearchQuranAdapters.this.minSelected = bindingAdapterPosition;
                SearchQuranAdapters.this.maxSelected = bindingAdapterPosition;
            }
            SearchQuranAdapters.this.notifyDataSetChanged();
            if (SearchQuranAdapters.this.callback != null) {
                SearchQuranAdapters.this.callback.onClick(SearchQuranAdapters.this.minSelected, SearchQuranAdapters.this.maxSelected, (ItemQuranSearch) SearchQuranAdapters.this.searchList.get(bindingAdapterPosition));
            }
        }
    }
}
