...
import com.nurmontage.quranmaker.util.ColorSchemeGenerator;
import com.nurmontage.quranmaker.util.ColorUtils;
import com.nurmontage.quranmaker.util.bitmap.CreateGradient;
...
import com.nurmontage.quranmaker.model.entity.EntitySelectTool;
...
import com.nurmontage.quranmaker.ui.gesture.MoveGestureDetector;
import java.io.File;
...
public class BlurredImageView extends View implements View.OnTouchListener {
    ...
    public BlurredImageView(Context context) {
        ...
        this.startTime = -1L;
        this.gestureListener = new GestureDetector.SimpleOnGestureListener() { // from class: com.nurmontage.quranmaker.ui.view.BlurredImageView.1
    ...
    */
    protected void onDraw(android.graphics.Canvas r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nurmontage.quranmaker.ui.view.BlurredImageView.onDraw(android.graphics.Canvas):void");
    }
    ...
    private void saveProgressBitmap(File file, float f) {
        ...
        saveBitmap(createBitmap, file, Common.LINE_PROGRESS);
    }
    ...
    public void setSurahNameEntity(String str, String str2, RectF rectF, float f, String str3, int i, int i2, int i3, int i4, boolean z, int i5) {
        ...
        } else if (!Utils.isProbablyArabic(str4)) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.String setupBitmapDraw(android.graphics.Bitmap r19, android.graphics.Bitmap r20, com.nurmontage.quranmaker.model.template.Template r21) {
        /*
            Method dump skipped, instructions count: 511
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nurmontage.quranmaker.ui.view.BlurredImageView.setupBitmapDraw(android.graphics.Bitmap, android.graphics.Bitmap, com.nurmontage.quranmaker.model.template.Template):java.lang.String");
    }
    ...
    public void updatePosSurahName() {
        ...
        if (this.surahNameEntity != null) {
            ...
            } else if (!Utils.isProbablyArabic(this.surahNameEntity.getReader())) {
                if (this.mIpadType == IpadType.IPAD.ordinal() || this.mIpadType == IpadType.IPAD_UNBLUR.ordinal() || this.mIpadType == IpadType.IPAD_CLASSIC.ordinal()) {
                    float width5 = this.rectFSurahName.width();
                    this.left_square = this.ipad_rect.centerX() - (this.bitmapSquare.getWidth() * 0.5f);
                    if (this.mIpadType == IpadType.IPAD_CLASSIC.ordinal()) {
    ...
    private class MoveListener extends MoveGestureDetector.SimpleOnMoveGestureListener {
        ...
        @Override // com.nurmontage.quranmaker.ui.gesture.MoveGestureDetector.SimpleOnMoveGestureListener, com.nurmontage.quranmaker.ui.gesture.MoveGestureDetector.OnMoveGestureListener
