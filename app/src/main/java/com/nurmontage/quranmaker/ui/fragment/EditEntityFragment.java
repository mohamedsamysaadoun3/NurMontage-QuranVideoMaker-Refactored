...
import com.nurmontage.quranmaker.databinding.FragmentEditEntityBinding;
...
public class EditEntityFragment extends Fragment {
    ...
    private TextCustomFont tv_from_now;
    private TextCustomFont tv_icon;
    private TextCustomFont tv_until_now;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditEntityCallback != null && this.resources != null) {
            ...
            ((TextCustomFont) root.findViewById(R.id.tv_delete)).setText(this.resources.getString(R.string.delete));
            TextCustomFont textCustomFont = (TextCustomFont) root.findViewById(R.id.tv_cut);
            this.tv_cut = textCustomFont;
            textCustomFont.setText(this.resources.getString(R.string.cut));
            ((TextCustomFont) root.findViewById(R.id.tv_edit)).setText(this.resources.getString(R.string.edit));
            ((TextCustomFont) root.findViewById(R.id.tv_color)).setText(this.resources.getString(R.string.color));
            root.findViewById(R.id.btn_color).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.1
            ...
            root.findViewById(R.id.btn_delete).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_edit).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.4
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            TextCustomFont textCustomFont2 = (TextCustomFont) root.findViewById(R.id.tv_from_now);
            this.tv_from_now = textCustomFont2;
            textCustomFont2.setText(this.resources.getString(R.string.from_now));
            ((TextCustomFont) root.findViewById(R.id.tv_from_the_start)).setText(this.resources.getString(R.string.from_the_start));
            TextCustomFont textCustomFont3 = (TextCustomFont) root.findViewById(R.id.tv_until_now);
            this.tv_until_now = textCustomFont3;
            textCustomFont3.setText(this.resources.getString(R.string.until_now));
            ((TextCustomFont) root.findViewById(R.id.tv_until_the_end)).setText(this.resources.getString(R.string.until_the_end));
            ((TextCustomFont) root.findViewById(R.id.tv_duplicate)).setText(this.resources.getString(R.string.duplicate));
            ((TextCustomFont) root.findViewById(R.id.tv_font)).setText(this.resources.getString(R.string.font));
            ((TextCustomFont) root.findViewById(R.id.tv_anim)).setText(this.resources.getString(R.string.animtion));
            LinearLayout linearLayout2 = (LinearLayout) root.findViewById(R.id.btn_from_now);
            this.btn_from_now = linearLayout2;
            linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.5
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_from_the_start).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.6
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.7
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_until_the_end).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.8
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_duplicate).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.9
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_font).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.10
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            TextCustomFont textCustomFont4 = (TextCustomFont) root.findViewById(R.id.tv_icon);
            this.tv_icon = textCustomFont4;
            textCustomFont4.setText(this.resources.getString(R.string.icon));
            ...
            linearLayout4.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.11
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            root.findViewById(R.id.btn_anim).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.12
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (EditEntityFragment.this.iEditEntityCallback != null) {
            ...
            ((HorizontalScrollView) root.findViewById(R.id.scroll_menu)).setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.EditEntityFragment.13
