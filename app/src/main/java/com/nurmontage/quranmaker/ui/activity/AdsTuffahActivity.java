...
public class AdsTuffahActivity extends Base {
    ...
    private final Runnable updateProgressTask = new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity.1
    ...
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity.2
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity$$ExternalSyntheticLambda0
        ...
        setString();
        findViewById(R.id.btn_on_back).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity.3
        ...
        this.btnPlayPause.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AdsTuffahActivity.this.m460lambda$onCreate$1$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(view);
            }
        });
        this.btnPlayPauseAfter.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AdsTuffahActivity.this.m461lambda$onCreate$2$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(view);
            }
        });
        this.waveformViewAfter.setOnWaveformClickListener(new WaveformView.OnWaveformClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity$$ExternalSyntheticLambda3
            @Override // com.nurmontage.quranmaker.ui.view.WaveformView.OnWaveformClickListener
            public final void onProgressChanged(float f) {
                AdsTuffahActivity.this.m462lambda$onCreate$3$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(f);
            }
        });
        this.waveformViewBefore.setOnWaveformClickListener(new WaveformView.OnWaveformClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity$$ExternalSyntheticLambda4
            @Override // com.nurmontage.quranmaker.ui.view.WaveformView.OnWaveformClickListener
            public final void onProgressChanged(float f) {
                AdsTuffahActivity.this.m463lambda$onCreate$4$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(f);
            }
        });
        findViewById(R.id.btn_tuffah).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    /* renamed from: lambda$onCreate$1$com-nurmontage-quranmaker-ui-activity-AdsTuffahActivity, reason: not valid java name */
    /* synthetic */ void m460lambda$onCreate$1$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(View view) {
        switchAudio(R.raw.before, this.btnPlayPause, this.waveformViewBefore);
    }

    /* renamed from: lambda$onCreate$2$com-nurmontage-quranmaker-ui-activity-AdsTuffahActivity, reason: not valid java name */
    /* synthetic */ void m461lambda$onCreate$2$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(View view) {
        switchAudio(R.raw.after, this.btnPlayPauseAfter, this.waveformViewAfter);
    }

    /* renamed from: lambda$onCreate$3$com-nurmontage-quranmaker-ui-activity-AdsTuffahActivity, reason: not valid java name */
    /* synthetic */ void m462lambda$onCreate$3$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(float f) {
    ...
    /* renamed from: lambda$onCreate$4$com-nurmontage-quranmaker-ui-activity-AdsTuffahActivity, reason: not valid java name */
    /* synthetic */ void m463lambda$onCreate$4$com.nurmontage.quranmaker.ui.activityAdsTuffahActivity(float f) {
        if (this.mediaPlayer != null) {
            this.mediaPlayer.seekTo((int) (r0.getDuration() * f));
            if (this.mediaPlayer.isPlaying()) {
                return;
    ...
    private void setupMediaPlayer(int i) {
        ...
        create.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { // from class: com.nurmontage.quranmaker.ui.activity.AdsTuffahActivity$$ExternalSyntheticLambda5
    ...
    /* renamed from: lambda$setupMediaPlayer$5$com-nurmontage-quranmaker-ui-activity-AdsTuffahActivity, reason: not valid java name */
