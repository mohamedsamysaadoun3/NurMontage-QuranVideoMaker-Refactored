...
public class GalleryPickerAdapters extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public GalleryPickerAdapters(String str, Resources resources, List<GallerySelected> list, int i, GalleryPickerVideo.IPicker iPicker) {
        this.size = i;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.adapter.GalleryPickerAdapters.MyViewHolder.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    if (GalleryPickerAdapters.this.iPicker == null || MyViewHolder.this.getAdapterPosition() < 0) {
                        return;
                    }
                    if (GalleryPickerAdapters.this.gallerySelectedList == null) {
                        PhotoItem photoItem = (PhotoItem) GalleryPickerAdapters.this.paths.get(MyViewHolder.this.getAdapterPosition());
                        if (photoItem == GalleryPickerAdapters.this.photoItem_selected) {
                            return;
                        }
                        if (GalleryPickerAdapters.this.photoItem_selected != null) {
                            GalleryPickerAdapters.this.photoItem_selected.setSelect(false);
                            GalleryPickerAdapters.this.notifyItemChanged(GalleryPickerAdapters.this.photoItem_selected.getAdapter_pos());
                        }
                        photoItem.setSelect(true);
                        MyViewHolder.this.imageView.onSelect(true);
                        GalleryPickerAdapters.this.photoItem_selected = photoItem;
                        photoItem.setAdapter_pos(MyViewHolder.this.getAdapterPosition());
                        GalleryPickerAdapters.this.iPicker.onAdd(photoItem, MyViewHolder.this.getAdapterPosition());
                        return;
                    }
                    PhotoItem photoItem2 = (PhotoItem) GalleryPickerAdapters.this.paths.get(MyViewHolder.this.getAdapterPosition());
                    photoItem2.setSelect(!photoItem2.isSelect());
                    MyViewHolder.this.imageView.onSelect(photoItem2.isSelect());
                    if (photoItem2.isSelect()) {
                        MyViewHolder.this.imageView.setNumber(GalleryPickerAdapters.this.gallerySelectedList.size() + 1);
                        photoItem2.setNumber(MyViewHolder.this.imageView.getAnInt());
                        photoItem2.setAdapter_pos(MyViewHolder.this.getAdapterPosition());
                        GalleryPickerAdapters.this.iPicker.onAdd(photoItem2, MyViewHolder.this.getAdapterPosition());
                        return;
                    }
                    GalleryPickerAdapters.this.updateNumbers(MyViewHolder.this.imageView.getAnInt());
                    GalleryPickerAdapters.this.iPicker.onDelete(photoItem2.getGallerySelected());
                }
            });
        }
    }
    ...
    public void updateNumbers(int i) {
        ...
        while (i < this.gallerySelectedList.size()) {
            ...
            if (photoItem != null) {
                ...
                notifyItemChanged(photoItem.getAdapter_pos());
            }
            i++;
        }
    }
