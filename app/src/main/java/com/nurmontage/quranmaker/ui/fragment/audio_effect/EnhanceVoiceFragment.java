...
public class EnhanceVoiceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditMediaCallback != null && this.entityAudio != null) {
            ...
            this.btn_remove_noice.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EnhanceVoiceFragment.1
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    EnhanceVoiceFragment.this.apply(false);
                }
            });
            ((TextCustomFont) root.findViewById(R.id.tv_remove_noice)).setText(getResources().getString(R.string.enhance_voice));
            root.findViewById(R.id.btn_appl_all).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EnhanceVoiceFragment$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    EnhanceVoiceFragment.this.m1170x3558a6b5(view);
                }
            });
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EnhanceVoiceFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.EnhanceVoiceFragment$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    /* renamed from: lambda$onCreateView$0$com-nurmontage-quranmaker-ui-fragment-audio_effect-EnhanceVoiceFragment, reason: not valid java name */
    /* synthetic */ void m1170x3558a6b5(View view) {
        apply(true);
    }

    /* renamed from: lambda$onCreateView$1$com-nurmontage-quranmaker-ui-fragment-audio_effect-EnhanceVoiceFragment, reason: not valid java name */
    /* synthetic */ void m1171xb7a35b94(View view) {
        onDone();
    }

    /* renamed from: lambda$onCreateView$2$com-nurmontage-quranmaker-ui-fragment-audio_effect-EnhanceVoiceFragment, reason: not valid java name */
