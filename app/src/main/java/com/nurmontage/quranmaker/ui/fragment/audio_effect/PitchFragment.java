...
public class PitchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.volumeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.PitchFragment.1
        ...
        root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.PitchFragment$$ExternalSyntheticLambda0
        ...
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.PitchFragment$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* renamed from: lambda$onCreateView$0$com-nurmontage-quranmaker-ui-fragment-audio_effect-PitchFragment, reason: not valid java name */
    /* synthetic */ void m1182x317f43af(View view) {
        done();
    }

    /* renamed from: lambda$onCreateView$1$com-nurmontage-quranmaker-ui-fragment-audio_effect-PitchFragment, reason: not valid java name */
