...
import com.nurmontage.quranmaker.ui.adapter.FontTextAdapters;
...
public class FontFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            final FontTextAdapters fontTextAdapters = new FontTextAdapters(fontProvider, this.iFontCallback, fontProvider.getFontNamesQuran(), indexOf);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
            this.linearLayoutManager = linearLayoutManager;
            this.recyclerView.setLayoutManager(linearLayoutManager);
            this.recyclerView.setHasFixedSize(true);
            this.recyclerView.setAdapter(fontTextAdapters);
            final LinearSnapHelper linearSnapHelper = new LinearSnapHelper();
            linearSnapHelper.attachToRecyclerView(this.recyclerView);
            this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.nurmontage.quranmaker.ui.fragment.FontFragment.1
                ...
                public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                    ...
                    if (findSnapView != null) {
                        ...
                        FontFragment.this.recyclerView.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.fragment.FontFragment.1.1
                            @Override // java.lang.Runnable
                            public void run() {
                                if (fontTextAdapters != null) {
                                    fontTextAdapters.setSelected(position);
                                }
                            }
                        });
                    }
            ...
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.FontFragment.2
            ...
            root.findViewById(R.id.btn_cancel).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.FontFragment.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
