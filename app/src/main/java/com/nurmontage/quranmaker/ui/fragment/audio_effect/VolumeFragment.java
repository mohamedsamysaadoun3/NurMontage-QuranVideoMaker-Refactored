...
public class VolumeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.volumeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.VolumeFragment.1
        ...
        root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.VolumeFragment$$ExternalSyntheticLambda0
        ...
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.VolumeFragment$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                VolumeFragment.this.m1204xdd25c18a(view);
            }
        });
        root.findViewById(R.id.btn_appl_all).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.VolumeFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* renamed from: lambda$onCreateView$0$com-nurmontage-quranmaker-ui-fragment-audio_effect-VolumeFragment, reason: not valid java name */
    /* synthetic */ void m1203x72f6396b(View view) {
        done();
    }

    /* renamed from: lambda$onCreateView$1$com-nurmontage-quranmaker-ui-fragment-audio_effect-VolumeFragment, reason: not valid java name */
    /* synthetic */ void m1204xdd25c18a(View view) {
        previewAudio();
    }

    /* renamed from: lambda$onCreateView$2$com-nurmontage-quranmaker-ui-fragment-audio_effect-VolumeFragment, reason: not valid java name */
