...
import com.nurmontage.quranmaker.util.bitmap.JavaBM;
import com.nurmontage.quranmaker.util.LocaleHelper;
import com.nurmontage.quranmaker.util.file.QuranPreference;
import com.nurmontage.quranmaker.util.RemoveTashkeel;
import com.nurmontage.quranmaker.util.Utils;
import com.nurmontage.quranmaker.ui.adapter.SearchQuranAdapters;
import com.nurmontage.quranmaker.model.ItemQuranSearch;
...
public class QuranSearchActivity extends Base {
    private ButtonCustomFont btnDone;
    ...
    private SearchQuranAdapters searchQuranAdapter;
    ...
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity.2
    ...
    private final SearchQuranAdapters.ISearchQuranCallback iSearchQuranCallback = new SearchQuranAdapters.ISearchQuranCallback() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity.4
        @Override // com.nurmontage.quranmaker.ui.adapter.SearchQuranAdapters.ISearchQuranCallback
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda1
        ...
        findViewById(R.id.btn_onBack).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda2
        ...
        buttonCustomFont.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity.1
            @Override // android.view.View.OnClickListener
        ...
        ((TextCustomFont) findViewById(R.id.tv_tittle)).setText(getResources().getString(R.string.search));
        ...
        SearchQuranAdapters searchQuranAdapters = new SearchQuranAdapters(this.iSearchQuranCallback);
        this.searchQuranAdapter = searchQuranAdapters;
        this.recyclerView.setAdapter(searchQuranAdapters);
        ...
        this.editText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda3
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                return QuranSearchActivity.this.m844xff99d684(textView, i, keyEvent);
            }
        });
        findViewById(R.id.btn_search).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* renamed from: lambda$onCreate$1$com-nurmontage-quranmaker-ui-activity-QuranSearchActivity, reason: not valid java name */
    ...
    /* renamed from: lambda$onCreate$2$com-nurmontage-quranmaker-ui-activity-QuranSearchActivity, reason: not valid java name */
    ...
    /* renamed from: lambda$onCreate$3$com-nurmontage-quranmaker-ui-activity-QuranSearchActivity, reason: not valid java name */
    ...
    private void performSearch() throws InterruptedException {
        ...
        if (trim.isEmpty() || trim.equals("--") || !Utils.isProbablyArabic(trim)) {
            return;
        }
        String str = this.lastSearchKey;
        if (str == null || !str.equals(trim)) {
            this.lastSearchKey = trim.replace("\"", "");
            SearchQuranAdapters searchQuranAdapters = this.searchQuranAdapter;
            if (searchQuranAdapters != null) {
                searchQuranAdapters.clear();
            }
    ...
    private void searchAllQuran() throws InterruptedException {
        ...
        this.isRun = true;
        Thread thread = new Thread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda0
    ...
    /* renamed from: lambda$searchAllQuran$7$com-nurmontage-quranmaker-ui-activity-QuranSearchActivity, reason: not valid java name */
    /* synthetic */ void m849xd4a8c370() {
        Handler handler;
        Runnable runnable;
        String readLine;
        this.handler.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
        ...
        try {
            try {
                ...
                while (this.isRun && (readLine = this.bufferedReader_quran.readLine()) != null && !readLine.isEmpty()) {
                    ...
                    if (split.length >= 3) {
                        ...
                        if (match != -1) {
                            this.handler.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda6
                                @Override // java.lang.Runnable
                                public final void run() {
                ...
                runnable = new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            closeQuranStreams();
            this.handler.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    QuranSearchActivity.this.m848xd51f296f();
                }
    ...
    /* renamed from: lambda$searchAllQuran$4$com-nurmontage-quranmaker-ui-activity-QuranSearchActivity, reason: not valid java name */
    ...
    /* renamed from: lambda$searchAllQuran$5$com-nurmontage-quranmaker-ui-activity-QuranSearchActivity, reason: not valid java name */
    ...
    /* renamed from: lambda$searchAllQuran$6$com-nurmontage-quranmaker-ui-activity-QuranSearchActivity, reason: not valid java name */
    /* synthetic */ void m848xd51f296f() {
        SearchQuranAdapters searchQuranAdapters = this.searchQuranAdapter;
        if (searchQuranAdapters != null && searchQuranAdapters.getSize() == 0) {
            updateCount();
        }
        ProgressBar progressBar = this.searchProgressBar;
        if (progressBar != null) {
    ...
    private void searchBySurah() throws InterruptedException {
        ...
        if (this.runnableBySurah == null) {
            this.runnableBySurah = new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity.3
                @Override // java.lang.Runnable
                public void run() {
                    String readLine;
                    QuranSearchActivity.this.handler.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity.3.1
                        @Override // java.lang.Runnable
                        public void run() {
                    ...
                    try {
                            ...
                            try {
                                ...
                                while (QuranSearchActivity.this.isRun && (readLine = QuranSearchActivity.this.bufferedReader_quran.readLine()) != null && !readLine.isEmpty()) {
                                    ...
                                    if (parseInt == QuranSearchActivity.this.indexSurah && (QuranSearchActivity.this.indexAya == -1 || QuranSearchActivity.this.indexAya == parseInt2)) {
                                        QuranSearchActivity.this.handler.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity.3.2
                                            @Override // java.lang.Runnable
                                            public void run() {
                        ...
                        QuranSearchActivity.this.handler.post(new Runnable() { // from class: com.nurmontage.quranmaker.ui.activity.QuranSearchActivity.3.3
                            @Override // java.lang.Runnable
                            public void run() {
