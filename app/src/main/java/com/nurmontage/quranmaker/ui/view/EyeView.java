...
public class EyeView extends View {
    ...
    public void openEye() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.nurmontage.quranmaker.ui.view.EyeView$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                EyeView.this.m1241lambda$openEye$0$com.nurmontage.quranmaker.ui.viewEyeView(valueAnimator);
            }
        });
    ...
    /* renamed from: lambda$openEye$0$com-nurmontage-quranmaker-ui-view-EyeView, reason: not valid java name */
    /* synthetic */ void m1241lambda$openEye$0$com.nurmontage.quranmaker.ui.viewEyeView(ValueAnimator valueAnimator) {
