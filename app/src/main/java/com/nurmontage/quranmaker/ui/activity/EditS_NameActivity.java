...
import com.nurmontage.quranmaker.ui.adapter.ColorBgAdapter;
...
public class EditS_NameActivity extends Base {
    ...
    private CheckboxCustomFont checkBg;
    private int clrBg;
    private EditTextCustomFont editText;
    private int index_surah;
    private Resources mResources;
    private RecyclerView recyclerView;
    private int style;
    private TextCustomFont tvOption1;
    private TextCustomFont tvOption2;
    private final OnBackPressedCallback onBackPressedCallback = new OnBackPressedCallback(true) { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.1
    ...
    private final ColorBgAdapter.IColor iColor = new ColorBgAdapter.IColor() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.8
        @Override // com.nurmontage.quranmaker.ui.adapter.ColorBgAdapter.IColor
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), new OnApplyWindowInsetsListener() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity$$ExternalSyntheticLambda0
        ...
        TextCustomFontBold textCustomFontBold = (TextCustomFontBold) findViewById(R.id.tv_tittle);
        TextCustomFontBold textCustomFontBold2 = (TextCustomFontBold) findViewById(R.id.tv_reader_name);
        TextCustomFontBold textCustomFontBold3 = (TextCustomFontBold) findViewById(R.id.tv_add_bg);
        textCustomFontBold3.setText(this.mResources.getString(R.string.add_bg));
        textCustomFontBold.setText(this.mResources.getString(R.string.edit_and_style));
        textCustomFontBold2.setText(this.mResources.getString(R.string.reader_name));
        this.checkBg = (CheckboxCustomFont) findViewById(R.id.checkbox_bg);
        EditTextCustomFont editTextCustomFont = (EditTextCustomFont) findViewById(R.id.edt_reader);
        this.editText = editTextCustomFont;
        editTextCustomFont.requestFocus();
        ...
        showKeyboard();
        this.tvOption1 = (TextCustomFont) findViewById(R.id.tv_option_1);
        this.tvOption2 = (TextCustomFont) findViewById(R.id.tv_option_2);
        ...
        this.tvOption1.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.2
        ...
        this.tvOption2.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        findViewById(R.id.btn_on_back).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                EditS_NameActivity.this.onBackPressedCallback.handleOnBackPressed();
            }
        });
        findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        textCustomFontBold3.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        initRv();
        this.checkBg.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.nurmontage.quranmaker.ui.activity.EditS_NameActivity.7
    ...
    private void initRv() {
        ...
        ColorBgAdapter.IColor iColor = this.iColor;
        int[] iArr = this.BG_COLORS;
        this.adapter = new ColorBgAdapter(iColor, iArr, Utils.indexOf(iArr, this.clrBg));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void selectOption(TextCustomFont textCustomFont, TextCustomFont textCustomFont2) {
        textCustomFont.setBackgroundResource(R.drawable.bg_option_surah_selected);
        textCustomFont.setTextColor(-1);
        textCustomFont2.setBackgroundResource(R.drawable.bg_option_surah_unselected);
        textCustomFont2.setTextColor(Color.parseColor("#888888"));
    }
