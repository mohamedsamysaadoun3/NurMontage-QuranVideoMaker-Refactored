...
import com.nurmontage.quranmaker.databinding.FragmentVolumeBinding;
...
public class SpeedFragment extends Fragment {
    ...
    private TextCustomFont tvProgress;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (entityAudio != null && entityAudio.getMediaPlayer() != null && this.iVolumeCallback != null) {
            this.tvProgress = (TextCustomFont) root.findViewById(R.id.tv_volume_size);
            ((TextCustomFont) root.findViewById(R.id.tv_volume)).setText(getResources().getString(R.string.speed));
            ...
            this.volumeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.SpeedFragment.1
            ...
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.SpeedFragment$$ExternalSyntheticLambda0
            ...
            imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.SpeedFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SpeedFragment.this.m1197x5ebe01b7(view);
                }
            });
            root.findViewById(R.id.btn_appl_all).setOnClickListener(new View.OnClickListener() { // from class: com.nurmontage.quranmaker.ui.fragment.audio_effect.SpeedFragment$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    /* renamed from: lambda$onCreateView$0$com-nurmontage-quranmaker-ui-fragment-audio_effect-SpeedFragment, reason: not valid java name */
    /* synthetic */ void m1196x10fe89b6(View view) {
        done();
    }

    /* renamed from: lambda$onCreateView$1$com-nurmontage-quranmaker-ui-fragment-audio_effect-SpeedFragment, reason: not valid java name */
    /* synthetic */ void m1197x5ebe01b7(View view) {
        previewAudio();
    }

    /* renamed from: lambda$onCreateView$2$com-nurmontage-quranmaker-ui-fragment-audio_effect-SpeedFragment, reason: not valid java name */
