...
public class BeforeAfterView extends View {
    ...
    private void init(final Context context) {
        ...
        new Thread(new Runnable() { // from class: com.nurmontage.quranmaker.ui.view.BeforeAfterView.1
    ...
    private void initHintAnimation(int i) {
        ...
        if (valueAnimator == null || !valueAnimator.isRunning()) {
            ...
            this.hintAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.nurmontage.quranmaker.ui.view.BeforeAfterView.2
