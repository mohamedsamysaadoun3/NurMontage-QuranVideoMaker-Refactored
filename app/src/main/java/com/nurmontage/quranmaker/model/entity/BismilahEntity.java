package com.nurmontage.quranmaker.model.entity;
...
public class BismilahEntity extends EntityView implements Serializable {
    ...
    public void applyAyaPreset(Paint paint, AyaTextPreset ayaTextPreset, int i, Typeface typeface, float f) {
        ...
        paint.setColor(i);
        int i2 = AnonymousClass1.$SwitchMap$com$nurmontage$quranmaker$constant$AyaTextPreset[ayaTextPreset.ordinal()];
        if (i2 != 2) {
            if (i2 != 3) {
                if (i2 != 4) {
                    return;
        ...
        if (this.ipad_type == IpadType.HEART.ordinal() || this.ipad_type == IpadType.BATTERY.ordinal() || this.ipad_type == IpadType.BLUE_TYPE.ordinal()) {
            paint.setColor(com.nurmontage.quranmaker.util.ColorUtils.lightenColor(i, 0.85f));
        } else {
            paint.setColor(com.nurmontage.quranmaker.util.ColorUtils.darkenColor(i, 0.85f));
        }
    }

    /* renamed from: com.nurmontage.quranmaker.model.entity.BismilahEntity$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$nurmontage$quranmaker$constant$AyaTextPreset;

        static {
            int[] iArr = new int[AyaTextPreset.values().length];
            $SwitchMap$com$nurmontage$quranmaker$constant$AyaTextPreset = iArr;
            try {
                iArr[AyaTextPreset.NONE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$nurmontage$quranmaker$constant$AyaTextPreset[AyaTextPreset.OUTLINE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$nurmontage$quranmaker$constant$AyaTextPreset[AyaTextPreset.SHADOW.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$nurmontage$quranmaker$constant$AyaTextPreset[AyaTextPreset.GLOW.ordinal()] = 4;
    ...
    public void setTextSizeInLoop(float f) {
        this.paintAya.setTextSize(f);
    ...
    @Override // com.nurmontage.quranmaker.model.entity.EntityView
