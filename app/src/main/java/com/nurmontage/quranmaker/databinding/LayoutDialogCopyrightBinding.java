...
public final class LayoutDialogCopyrightBinding implements ViewBinding {
    ...
    private LayoutDialogCopyrightBinding(LinearLayout linearLayout, ImageButton imageButton, TextCustomFontBold textCustomFontBold, TextCustomFont textCustomFont) {
        ...
        if (imageButton != null) {
            ...
            if (textCustomFontBold != null) {
                ...
                if (textCustomFont != null) {
                    return new LayoutDialogCopyrightBinding((LinearLayout) view, imageButton, textCustomFontBold, textCustomFont);
                }
            }
        }
