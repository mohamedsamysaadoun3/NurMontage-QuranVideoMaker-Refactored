...
public final class LayoutTablayoutBinding implements ViewBinding {
    ...
    public final TextCustomFont name;
    private final LinearLayout rootView;

    private LayoutTablayoutBinding(LinearLayout linearLayout, ImageView imageView, TextCustomFont textCustomFont) {
        this.rootView = linearLayout;
        this.icon = imageView;
        this.name = textCustomFont;
    }
    ...
    public static LayoutTablayoutBinding bind(View view) {
        ...
        if (imageView != null) {
            ...
            if (textCustomFont != null) {
                return new LayoutTablayoutBinding((LinearLayout) view, imageView, textCustomFont);
            }
        }
